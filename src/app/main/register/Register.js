                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            <Typography variant="h6" className="md:w-full mb-32">{translate('Register')}</Typography>
                            ...
                            <div className="flex flex-col items-center justify-center pt-32 pb-24">
                                <span className="font-medium">{translate('Registered')}</span>
                                <Link className="font-medium" to="/login">{translate('Login')}</Link>
                                <Link className="font-medium mt-8" to="/">{translate('Dashboard')}</Link>
                            </div>
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Register))));
