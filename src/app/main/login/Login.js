                ...
                <FuseAnimate animation={{translateX: [0, '100%']}}>
                    ...
                    <Card className="w-full max-w-400 mx-auto m-16 md:m-0" square>
                        ...
                        <CardContent className="flex flex-col items-center justify-center p-32 md:p-48 md:pt-128 ">
                            ...
                            <Typography variant="h6" className="text-center md:w-full mb-48">{translate('Login')}</Typography>
                            ...
                            <div className="flex flex-col items-center justify-center pt-32">
                                <span className="font-medium">{translate('Register')}</span>
                                <Link className="font-medium" to="/register">{translate('Register')}</Link>
...
export default withStyles(styles, {withTheme: true})(withRouter(withTranslate(Login)));
