...
{
    return {
        categorys          : galleryCategoryApp.categorys.entities,
        searchText     : galleryCategoryApp.categorys.searchText,
        orderBy        : galleryCategoryApp.categorys.orderBy,
        orderDescending: galleryCategoryApp.categorys.orderDescending
    }
}
