...
{
    return {
        categorylabels : galleryCategoryApp.categorylabels.entities,
        searchText     : galleryCategoryApp.categorylabels.searchText,
        orderBy        : galleryCategoryApp.categorylabels.orderBy,
        orderDescending: galleryCategoryApp.categorylabels.orderDescending
    }
}
