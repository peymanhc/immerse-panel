...
export const GET_CATEGORYS = '[GALLERY CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[GALLERY CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[GALLERY CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[GALLERY CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[GALLERY CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[GALLERY CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[GALLERY CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[GALLERY CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[GALLERY CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[GALLERY CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[GALLERY CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[GALLERY CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[GALLERY CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[GALLERY CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[GALLERY CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[GALLERY CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[GALLERY CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[GALLERY CATEGORY APP] ADD LOADING CATEGORY';
...
{
    const request = axios.get('/api/gallery-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().galleryCategoryApp.categorys;
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/gallery-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/gallery-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/gallery-category-app/remove-category', {data:{categoryId}});
