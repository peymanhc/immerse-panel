...
import UserManagmentHeader from './UserManagmentHeader';
...
class userManagmentApp extends Component {
			...
			<div>
                ...
                <FuseAnimate animation="transition.expandIn" delay={300}>
                    <Fab
						...
						onClick={() => {value === 0 ? openNewUserDialog() : openNewRoleDialog()}}
                    >
					{
...
export default withReducer('UsersApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(userManagmentApp))));
