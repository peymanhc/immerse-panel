...
class SlidersLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeSlidersOrder,
        toggleOrderDescending: Actions.toggleSlidersOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(SlidersLabelToolbar);
