...
{
    return { 
        categoryDialog	: notebookCategoryApp.categorylabels.categoryDialog,
		loading			: notebookCategoryApp.categorylabels.loading,
		//types			: notebookCategoryApp.categorylabels.types,
    }
}
