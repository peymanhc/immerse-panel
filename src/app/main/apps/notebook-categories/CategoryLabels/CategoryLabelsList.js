...
{
    return {
        categorylabels : notebookCategoryApp.categorylabels.entities,
        searchText     : notebookCategoryApp.categorylabels.searchText,
        orderBy        : notebookCategoryApp.categorylabels.orderBy,
        orderDescending: notebookCategoryApp.categorylabels.orderDescending
    }
}
