...
const CategoryLabelsListItem = ({category, classes, openEditCategoryDialog, toggleImportant, toggleStarred}) => {
    return (
        <ListItem
            onClick={(ev) => {
                ev.preventDefault();
...
export default withStyles(styles, {withTheme: true})((connect(null, mapDispatchToProps))(CategoryLabelsListItem));
