...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/tradepage/posts/' + item.id + '/' + item.name);
    };
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell className="truncate" component="th" scope="row">
                                                {n.categories ? n.categories.join(', '):''}
                                            </TableCell>

                                            <TableCell component="th" scope="row" align="center">
                                                {n.content ? n.content.substring(0, 50):''}
												{ n.content.length > 50 ? '...': ''}
                                            </TableCell>

                                            <TableCell component="th" scope="row" align="left">
                                                {n.description ? moment(n.date).format('YYYY MMMM DD'):''}
                                            </TableCell>
...
{
    return {
        posts  : tradepageApp.posts.data,
        searchText: tradepageApp.posts.searchText,
		postsCount: tradepageApp.posts.count,
    }
}
