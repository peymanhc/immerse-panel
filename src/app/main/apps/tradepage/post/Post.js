...
class Post extends Component {
 ...
 ckEditorHandleChange = ( event, editor ) => {
        ...
        this.setState({form: _.set({...this.state.form}, "content", data)});
    };
    canBeSubmitted()
    {
    ...
    render()
    {
		...
		if(form && form.id && form.name)
			postLink = window.location.origin + "/tradepage/post-full/" + form.id + "/" + form.name.split(' ').join('-');
        ...
        return (
		 ...
		 <React.Fragment>
                        ...
                        <div className="flex flex-1 w-full items-center justify-between">
                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/apps/tradepage/posts">
                                 ...
                                 <div className="flex"> 
                                    ...
                                    <FuseChipSelect
                                     fullWidth
                                        ...
                                        placeholder={translate('CategoriesModal')}
                                        textFieldProps={{
                                            label          : translate('CategoriesModal'),
                                            InputLabelProps: {
                                                shrink: true,
            ...
            <div className="pb-8">        
                    ...
                    <Typography className="h2" color="textSecondary">  انتخاب ماژول ها </Typography>
                    </div>
                </div>
...
function mapStateToProps({tradepageApp})
{
    return {
        post: tradepageApp.post
    }
}

export default 
	withReducer('tradepageApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Post)))));
