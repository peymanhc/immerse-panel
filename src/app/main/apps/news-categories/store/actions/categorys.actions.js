...
export const GET_CATEGORYS = '[NEWS CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[NEWS CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[NEWS CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[NEWS CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[NEWS CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[NEWS CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[NEWS CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[NEWS CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[NEWS CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[NEWS CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[NEWS CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[NEWS CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[NEWS CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[NEWS CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[NEWS CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[NEWS CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[NEWS CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[NEWS CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[NEWS CATEGORY APP] GET TYPES';

export function getTypesC()
{
    const request = axios.get('/api/news-category-app/types');
...
{
    const request = axios.get('/api/news-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().newsCategoryApp.categorys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/news-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/news-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/news-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/news-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/news-category-app/remove-category', {data:{categoryId}});
