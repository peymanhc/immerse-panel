...
class CategoryDialog extends Component {
    ...
    render()
    {  
        const {categoryDialog, addCategory, updateCategory, removeCategory, classes, types} = this.props;
...
{
    return { 
        categoryDialog	: englishSkillCategoryApp.categorylabels.categoryDialog,
		loading			: englishSkillCategoryApp.categorylabels.loading,
