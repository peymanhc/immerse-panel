...
export const GET_CATEGORYLABELS = '[ACC CATEGORY APP] GET CATEGORYLABELS';
export const UPDATE_CATEGORYLABELS  = '[ACC CATEGORY APP] UPDATE CATEGORYLABELS';
export const OPEN_NEW_CATEGORYLABELS_DIALOG = '[ACC CATEGORY APP] OPEN NEW CATEGORYLABELS DIALOG';
export const CLOSE_NEW_CATEGORYLABELS_DIALOG = '[ACC CATEGORY APP] CLOSE NEW CATEGORYLABELS DIALOG';
export const OPEN_EDIT_CATEGORYLABELS_DIALOG = '[ACC CATEGORY APP] OPEN EDIT CATEGORYLABELS DIALOG';
export const CLOSE_EDIT_CATEGORYLABELS_DIALOG = '[ACC CATEGORY APP] CLOSE EDIT CATEGORYLABELS DIALOG';
export const SET_CATEGORYLABELS_SEARCH_TEXT = '[ACC CATEGORY APP] SET CATEGORYLABELS SEARCH TEXT';
export const TOGGLE_CATEGORYLABELS_ORDER_DESCENDING = '[ACC CATEGORY APP] TOGGLE CATEGORYLABELS ORDER DESCENDING';
export const CHANGE_CATEGORYLABELS_ORDER = '[ACC CATEGORY APP] CHANGE CATEGORYLABELS ORDER';
export const TOGGLE_STARRED = '[ACC CATEGORY APP] TOGGLE CATEGORYLABELS STARRED';
export const TOGGLE_IMPORTANT = '[ACC CATEGORY APP] TOGGLE CATEGORYLABELS IMPORTANT';
export const TOGGLE_ENABLE = '[ACC CATEGORY APP] TOGGLE CATEGORYLABELS ENABLE';
export const TOGGLE_DISABLE = '[ACC CATEGORY APP] TOGGLE CATEGORYLABELS DISABLE';
export const ADD_CATEGORYLABELS = '[ACC CATEGORY APP] ADD CATEGORYLABELS';
export const REMOVE_CATEGORYLABELS = '[ACC CATEGORY APP] REMOVE CATEGORYLABELS';
export const WAIT_CATEGORYLABELS = '[ACC CATEGORY APP] ADD LOADING CATEGORYLABELS';
...
export function updateCategoryLabel(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/acc-category-app/update-category-label', category);
...
{
    const request = axios.delete('/api/acc-category-app/remove-category-label', {data: {categoryId}});
