...
export const GET_CATEGORYS = '[ACC CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[ACC CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[ACC CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[ACC CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[ACC CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[ACC CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[ACC CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[ACC CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[ACC CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[ACC CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[ACC CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[ACC CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[ACC CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[ACC CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[ACC CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[ACC CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[ACC CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[ACC CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[ACC CATEGORY APP] GET TYPES';

export function getTypesC()
{
    const request = axios.get('/api/acc-category-app/types');
...
{
    const request = axios.get('/api/acc-category-app/categories', {
        params: match.params
    });
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/acc-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/acc-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/acc-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/acc-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/acc-category-app/remove-category', {data:{categoryId}});
