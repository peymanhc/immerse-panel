...
{
    return { 
        categoryDialog	: cameraCategoryApp.categorylabels.categoryDialog,
		loading			: cameraCategoryApp.categorylabels.loading,
		//types			: cameraCategoryApp.categorylabels.types,
    }
}
