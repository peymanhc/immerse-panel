...
{
    return {
        categorys          : cameraCategoryApp.categorys.entities,
        searchText     : cameraCategoryApp.categorys.searchText,
        orderBy        : cameraCategoryApp.categorys.orderBy,
        orderDescending: cameraCategoryApp.categorys.orderDescending
    }
}
