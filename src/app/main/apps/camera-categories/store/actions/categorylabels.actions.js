...
export function updateCategoryLabel(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/camera-category-app/update-category-label', category);
...
{
    const request = axios.delete('/api/camera-category-app/remove-category-label', {data: {categoryId}});
