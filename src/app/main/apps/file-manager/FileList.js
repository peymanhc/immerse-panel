...
const FileList = ({classes, files, selectedItem, setSelectedItem, pageLayout, translate}) => {
            ...
            <Table>
                ...
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell className="hidden sm:table-cell">{translate('Type')}</TableCell>
                        <TableCell className="hidden sm:table-cell">{translate('Owner')}</TableCell>
                        <TableCell className="text-center hidden sm:table-cell">{translate('Size')}</TableCell>
                        <TableCell className="hidden sm:table-cell">{translate('Modified')}</TableCell>
                    </TableRow>
                </TableHead>
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(FileList))));
