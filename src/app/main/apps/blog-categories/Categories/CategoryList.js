...
{
    return {
        categorys          : blogCategoryApp.categorys.entities,
        searchText     : blogCategoryApp.categorys.searchText,
        orderBy        : blogCategoryApp.categorys.orderBy,
        orderDescending: blogCategoryApp.categorys.orderDescending
    }
}
