...
{
    const request = axios.get('/api/ads-category-app/labels');
...
export function updateCategoryLabel(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/ads-category-app/update-category-label', category);
...
export function addCategoryLabels(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/ads-category-app/new-label', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/ads-category-app/remove-category-label', {data: {categoryId}});
