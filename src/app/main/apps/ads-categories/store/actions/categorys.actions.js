...
{
    const request = axios.get('/api/ads-category-app/types');
...
{
    const request = axios.get('/api/ads-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().adsCategoryApp.categorys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/ads-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/ads-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/ads-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/ads-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/ads-category-app/remove-category', {data:{categoryId}});
