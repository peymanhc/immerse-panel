...
{
    return {
        categoryDialog	: tradepageCategoryApp.categorys.categoryDialog,
        labels    		: tradepageCategoryApp.labels,
		loading			: tradepageCategoryApp.categorys.loading,
		//types			: tradepageCategoryApp.categorylabels.types,
    }
}
