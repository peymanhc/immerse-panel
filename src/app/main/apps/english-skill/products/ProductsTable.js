...
class ProductsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/english-skill/products/' + item.id + '/' + item.handle);
    };
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell component="th" scope="row">
                                              <Typography className="truncate">{n.name !==undefined ' - ': n.name}</Typography>
...
{
    return {
        products  : englishSkillApp.products.data,
        searchText: englishSkillApp.products.searchText,
		productsCount: englishSkillApp.products.count,
    }
}
