...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/gallery/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : galleryApp.posts.data,
        searchText: galleryApp.posts.searchText,
		postsCount: galleryApp.posts.count,
    }
}
