...
{
    const request = axios.get('/api/scrumboard-app/board', {params: {boardId}});
...
export function reorderList(result)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/scrumboard-app/list/order',
            {
                boardId: board.id,
                lists  : ordered
            }
...
export function reorderCard(result)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/scrumboard-app/card/order',
            {
                boardId: board.id,
                lists  : ordered
            }
...
{
    const request = axios.put('/api/scrumboard-app/list/rename',
        {
            boardId,
            listId,
            listTitle
...
{
    const request = axios.delete('/api/scrumboard-app/list/remove',
		{
			data:{
				boardId,
				listId
...
export function changeBoardSettings(newSettings)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/scrumboard-app/board/settings/update',
            {
                boardId: board.id,
                settings
            }
...
{
    const request = axios.delete('/api/scrumboard-app/board/delete',
		{
			data: {
				boardId
			}
...
{
    const request = axios.put('/api/scrumboard-app/board/rename',
        {
            boardId,
            boardTitle
        }
