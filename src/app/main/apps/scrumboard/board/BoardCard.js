...
class BoardCard extends Component {
    ...
    render()
    {
        const {classes, cardId, index, board, translate} = this.props;
                    ...
                    >
                        ...
                        >
                            ...
                            {board.settings.cardCoverImages && card.idAttachmentCover !== '' && (
                                <img className="block" src={_.find(card.attachments, {id: card.idAttachmentCover}).src} alt={translate('card_cover')}/>
                            )}
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(BoardCard))));
