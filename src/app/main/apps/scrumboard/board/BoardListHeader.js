...
class BoardListHeader extends Component {
    ...
    render()
    {
        const {board, list, handleProps, removeList, translate} = this.props;
                    ...
                    <div className="">
                        ...
                        >
                            <MenuItem onClick={() => {
                                ...
                                <ListItemText primary={translate("Remove_List")}/>
                            </MenuItem>
                            <MenuItem onClick={() => this.renameFormToggle(true)}>
                                <ListItemIcon>
                                    <Icon>edit</Icon>
                                </ListItemIcon>
                                <ListItemText primary={translate("Rename_List")}/>
                            </MenuItem>
                        </Menu>
                    </div>
                </div>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(BoardListHeader)));
