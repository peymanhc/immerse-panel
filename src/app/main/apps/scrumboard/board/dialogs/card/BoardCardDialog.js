...
class BoardCardDialog extends Component {
    ...
    render()
    {
        const {card, classes, removeCard, closeCardDialog, board, addLabel, handleChange, chipChange, 
			removeAttachment, removeDue, toggleLabel, toggleMember, addCheckList, checkListChange, removeCheckList, 
			commentAdd, makeCover, removeCover, addNewChip, translate} = this.props;
                    ...
                    <DialogContent className="p-16 sm:p-24">
                            ...
                            {card.idLabels.length > 0 && (
                                <div className="flex-1 mb-24">
                                    <div className="flex items-center mt-16 mb-12">
                                        ...
                                        <Typography className="font-600 text-16">{translate('Labels')}</Typography>
                                    </div>
                                    <FuseChipSelect
                                        ...
                                        placeholder={translate('Select_multiple_Labels')}
                                        isMulti
                                        textFieldProps={{
                                            variant: "outlined"
                                        }}
                            ...
                            {card.idMembers.length > 0 && (
                                <div className="flex-1 mb-24">
                                    <div className="flex items-center mt-16 mb-12">
                                        ...
                                        <Typography className="font-600 text-16">{translate('Members')}</Typography>
                                    </div>
                                    <FuseChipSelect
                        ...
                        {card.attachments.length > 0 && (
                            <div className="mb-24">
                                <div className="flex items-center mt-16 mb-12">
                                    ...
                                    <Typography className="font-600 text-16">{translate('Attachments')}</Typography>
                                </div>
                        ...
                        <div className="mb-24">
                            <div className="flex items-center mt-16 mb-12">
                                ...
                                <Typography className="font-600 text-16">{translate('Comment')}</Typography>
                            </div>
                            <div>
                                <CardComment
                                    members={board.members}
                        ...
                        {card.activities.length > 0 && (
                            <div className="mb-24">
                                <div className="flex items-center mt-16">
                                    ...
                                    <Typography className="font-600 text-16">{translate('Activity')}</Typography>
                                </div>
                                <List className="">
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(withTranslate(BoardCardDialog)));
