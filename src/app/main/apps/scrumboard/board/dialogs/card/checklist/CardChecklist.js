...
class CardChecklist extends Component {
    ...
    render()
    {
        const {onRemoveCheckList, translate} = this.props;
                    ...
                    <div className="">
                        ...
                        >
                            <MenuItem onClick={onRemoveCheckList}>
                                ...
                                <ListItemText primary={translate('Remove_Checklist')}/>
                            </MenuItem>
                            <MenuItem onClick={() => this.renameFormToggle(true)}>
                                <ListItemIcon>
                                    <Icon>edit</Icon>
                                </ListItemIcon>
                                <ListItemText primary={translate('Rename_Checklist')}/>
                            </MenuItem>
                        </Menu>
                    </div>
                </div>
...
export default withTranslate(CardChecklist);
