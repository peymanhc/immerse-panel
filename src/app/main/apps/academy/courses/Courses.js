...
class Courses extends Component {
    ...
    buttonStatus = (course) => {
        switch ( course.activeStep )
        {
            case course.totalSteps:
                return this.props.translate("COMPLETED");
            case 0:
                return this.props.translate("START");
            default:
    ...
    render()
    {
        const {classes, setSearchText, searchText, categories, categoryFilter, setCategoryFilter, theme, translate} = this.props;
            ...
            <div className="w-full">
                    ...
                    <FuseAnimate duration={400} delay={600}>
                        <Typography variant="subtitle1" color="inherit" className="mt-8 sm:mt-16 mx-auto max-w-512">
                            <span className="opacity-75">
							 {translate('Our_courses_will_step')}
                            </span>
                        </Typography>
                    </FuseAnimate>
                ...
                <div className="max-w-2xl w-full mx-auto px-8 sm:px-16 py-24">
                    <div className="flex flex-col sm:flex-row items-center justify-between py-24">
                        <TextField
                            label={translate('Search_for_a_course')}
                            placeholder={translate("Enter_a_keyword")}
                                    ...
                                    <Card elevation={1} className="flex flex-col h-256">
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center justify-center opacity-75">
                                                ...
                                                <div className="text-16 whitespace-no-wrap">{course.length} {translate("min")}</div>
                                            </div>
                                        </div>
...
export default withReducer('academyApp', reducer)(withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Courses))));
