...
{  
    return {
		open : imTvApp.product.propertyDialog.open,
		properties : imTvApp.product.properties,
		propertyLabels : imTvApp.product.propertyLabels,
		propertyLabelSelected : imTvApp.product.propertyLabelSelected,
		propertySelected : imTvApp.product.propertySelected,
		propertyEdit: imTvApp.product.propertyEdit,	
    }
}
