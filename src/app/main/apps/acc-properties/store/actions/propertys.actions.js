...
export const GET_PROPERTYS = '[ACC PROPERTY APP] GET PROPERTYS';
export const UPDATE_PROPERTYS = '[ACC PROPERTY APP] UPDATE PROPERTYS';
export const TOGGLE_STARRED = '[ACC PROPERTY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[ACC PROPERTY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[ACC PROPERTY APP] TOGGLE IMPORTANT';
export const UPDATE_PROPERTY = '[ACC PROPERTY APP] UPDATE PROPERTY';
export const ADD_PROPERTY = '[ACC PROPERTY APP] ADD PROPERTY';
export const REMOVE_PROPERTY = '[ACC PROPERTY APP] REMOVE PROPERTY';
export const SET_SEARCH_TEXT = '[ACC PROPERTY APP] SET SEARCH TEXT';
export const OPEN_NEW_PROPERTY_DIALOG = '[ACC PROPERTY APP] OPEN NEW PROPERTY DIALOG';
export const CLOSE_NEW_PROPERTY_DIALOG = '[ACC PROPERTY APP] CLOSE NEW PROPERTY DIALOG';
export const OPEN_EDIT_PROPERTY_DIALOG = '[ACC PROPERTY APP] OPEN EDIT PROPERTY DIALOG';
export const CLOSE_EDIT_PROPERTY_DIALOG = '[ACC PROPERTY APP] CLOSE EDIT PROPERTY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[ACC PROPERTY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[ACC PROPERTY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[ACC PROPERTY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[ACC PROPERTY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_PROPERTY = '[ACC PROPERTY APP] ADD LOADING PROPERTY';
...
{
    const request = axios.get('/api/acc-property-app/properties', {
        params: match.params
    });
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === 'post')
			axios.post('/api/acc-property-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	
		else
			axios.put('/api/acc-property-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateProperty(property)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, 'put').then((images) => { 
			...
			//console.log(property);
			const request = axios.put('/api/acc-property-app/update-property', property);
...
export function addProperty(property)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, 'post').then((images) => { 
			...
			delete property.images;	
			//console.log(property);
			const request = axios.post('/api/acc-property-app/new-property', property);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/acc-property-app/remove-property', {data:{propertyId}});
