...
export const GET_PROPERTYLABELS = '[ACC PROPERTY APP] GET PROPERTYLABELS';
export const UPDATE_PROPERTYLABELS  = '[ACC PROPERTY APP] UPDATE PROPERTYLABELS';
export const OPEN_NEW_PROPERTYLABELS_DIALOG = '[ACC PROPERTY APP] OPEN NEW PROPERTYLABELS DIALOG';
export const CLOSE_NEW_PROPERTYLABELS_DIALOG = '[ACC PROPERTY APP] CLOSE NEW PROPERTYLABELS DIALOG';
export const OPEN_EDIT_PROPERTYLABELS_DIALOG = '[ACC PROPERTY APP] OPEN EDIT PROPERTYLABELS DIALOG';
export const CLOSE_EDIT_PROPERTYLABELS_DIALOG = '[ACC PROPERTY APP] CLOSE EDIT PROPERTYLABELS DIALOG';
export const SET_PROPERTYLABELS_SEARCH_TEXT = '[ACC PROPERTY APP] SET PROPERTYLABELS SEARCH TEXT';
export const TOGGLE_PROPERTYLABELS_ORDER_DESCENDING = '[ACC PROPERTY APP] TOGGLE PROPERTYLABELS ORDER DESCENDING';
export const CHANGE_PROPERTYLABELS_ORDER = '[ACC PROPERTY APP] CHANGE PROPERTYLABELS ORDER';
export const TOGGLE_STARRED = '[ACC PROPERTY APP] TOGGLE PROPERTYLABELS STARRED';
export const TOGGLE_IMPORTANT = '[ACC PROPERTY APP] TOGGLE PROPERTYLABELS IMPORTANT';
export const TOGGLE_ENABLE = '[ACC PROPERTY APP] TOGGLE PROPERTYLABELS ENABLE';
export const TOGGLE_DISABLE = '[ACC PROPERTY APP] TOGGLE PROPERTYLABELS DISABLE';
export const ADD_PROPERTYLABELS = '[ACC PROPERTY APP] ADD PROPERTYLABELS';
export const REMOVE_PROPERTYLABELS = '[ACC PROPERTY APP] REMOVE PROPERTYLABELS';
export const WAIT_PROPERTYLABELS = '[ACC PROPERTY APP] ADD LOADING PROPERTYLABELS';
...
export function updatePropertyLabel(property)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, 'put').then((images) => { 
			...
			//console.log(property);
			const request = axios.put('/api/acc-property-app/update-property-label', property);
...
{
    const request = axios.delete('/api/acc-property-app/remove-property-label', {data: {propertyId}});
