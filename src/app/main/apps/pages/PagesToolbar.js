...
class PagesLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changePagesOrder,
        toggleOrderDescending: Actions.togglePagesOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(PagesLabelToolbar);
