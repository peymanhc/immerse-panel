...
class Chat extends Component {
    ...
    render()
    {
        const {classes, chat, contacts, user, className, translate} = this.props;
...
export default withStyles(styles)(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Chat)));
