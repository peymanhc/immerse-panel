...
class UserSidebar extends Component {
    ...
    render()
    {
        const {user, closeUserSidebar, translate} = this.props;
		const statusArr = [
			{
			...
			{
				title: translate('Away'),
				value: 'away'
			},
			{
				title: translate('Do_not_disturb'),
            ...
            <div className="flex flex-col flex-auto h-full">
                ...
                >
                    <Toolbar className="flex justify-between items-center px-16 pr-4">
                        <Typography color="inherit" variant="subtitle1">{translate('User_info')}</Typography>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(UserSidebar));
