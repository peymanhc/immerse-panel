...
{
    return {
        categorylabels : bookstoreCategoryApp.categorylabels.entities,
        searchText     : bookstoreCategoryApp.categorylabels.searchText,
        orderBy        : bookstoreCategoryApp.categorylabels.orderBy,
        orderDescending: bookstoreCategoryApp.categorylabels.orderDescending
    }
}
