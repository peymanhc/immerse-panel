...
class MailList extends Component {
    ...
    render()
    {
        const {mails, searchText, translate} = this.props;
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(MailList))));
