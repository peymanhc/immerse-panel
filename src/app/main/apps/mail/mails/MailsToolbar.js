...
class MailToolbar extends Component {
    ...
    render()
    {
        const {mails, selectAllMails, deselectAllMails, selectMailsByParameter, setFolderOnSelectedMails, toggleLabelOnSelectedMails, 
			folders, labels, selectedMailIds, translate} = this.props;
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(MailToolbar)));
