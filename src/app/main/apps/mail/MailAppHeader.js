...
const MailAppHeader = ({setSearchText, searchText, pageLayout, mainTheme, translate}) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(MailAppHeader));
