...
class WerehouselistLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeWerehouselistOrder,
        toggleOrderDescending: Actions.toggleWerehouselistOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(WerehouselistLabelToolbar);
