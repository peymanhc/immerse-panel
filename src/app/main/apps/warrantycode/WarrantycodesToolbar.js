...
class WarrantycodesLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeWarrantycodesOrder,
        toggleOrderDescending: Actions.toggleWarrantycodesOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(WarrantycodesLabelToolbar);
