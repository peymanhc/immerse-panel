...
class OtherPagesLabelToolbar extends Component {
      ...
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-center">
          ...
          <IconButton onClick={toggleOrderDescending}>
            <Icon
              style={{
                transform: orderDescending ? "scaleY(-1)" : "scaleY(1)"
              }}
            >
              sort
            </Icon>
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators(
    {
      changeOrder: Actions.changeOtherPagesOrder,
      toggleOrderDescending: Actions.toggleOtherPagesOrderDescending
    },
    dispatch
  );
}
