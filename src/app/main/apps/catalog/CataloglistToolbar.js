...
class CataloglistLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeCataloglistOrder,
        toggleOrderDescending: Actions.toggleCataloglistOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(CataloglistLabelToolbar);
