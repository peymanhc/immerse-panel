...
function mapStateToProps({imtvCategoryApp})
{
    return {
        categoryDialog	: imtvCategoryApp.categorys.categoryDialog,
        labels    		: imtvCategoryApp.labels,
		loading			: imtvCategoryApp.categorys.loading,
		types			: imtvCategoryApp.categorylabels.types,
    }
}
