...
class GatewaysLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeGatewaysOrder,
        toggleOrderDescending: Actions.toggleGatewaysOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(GatewaysLabelToolbar);
