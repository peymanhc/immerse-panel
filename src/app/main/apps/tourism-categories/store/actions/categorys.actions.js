...
export const GET_CATEGORYS = '[TOURISM CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[TOURISM CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[TOURISM CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[TOURISM CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[TOURISM CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[TOURISM CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[TOURISM CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[TOURISM CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[TOURISM CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[TOURISM CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[TOURISM CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[TOURISM CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[TOURISM CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[TOURISM CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[TOURISM CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[TOURISM CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[TOURISM CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[TOURISM CATEGORY APP] ADD LOADING CATEGORY';
...
{
    const request = axios.get('/api/tourism-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().tourismCategoryApp.categorys;
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/tourism-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/tourism-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/tourism-category-app/remove-category', {data:{categoryId}});
