...
export const GET_CATEGORYS = '[IDEA CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[IDEA CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[IDEA CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[IDEA CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[IDEA CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[IDEA CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[IDEA CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[IDEA CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[IDEA CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[IDEA CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[IDEA CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[IDEA CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[IDEA CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[IDEA CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[IDEA CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[IDEA CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[IDEA CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[IDEA CATEGORY APP] ADD LOADING CATEGORY';
...
{
    const request = axios.get('/api/idea-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().ideaCategoryApp.categorys;
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/idea-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/idea-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/idea-category-app/remove-category', {data:{categoryId}});
