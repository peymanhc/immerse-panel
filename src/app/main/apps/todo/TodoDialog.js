...
class TodoDialog extends Component {
    ...
    render()
    {
        const {todoDialog, addTodo, updateTodo, removeTodo, labels, translate} = this.props;
        ...
        return (
            <Dialog className="fuse" {...todoDialog.props} onClose={this.closeTodoDialog} fullWidth maxWidth="sm">

                <AppBar position="static" elevation={1}>
                    <Toolbar className="flex w-full">
                        <Typography variant="subtitle1" color="inherit">
                            {todoDialog.type === 'new' ? translate('New_Todo') : translate('Edit_Todo')}
                        </Typography>
                    </Toolbar>
                </AppBar>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(TodoDialog));
