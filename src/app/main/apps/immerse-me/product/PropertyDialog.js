...
function mapStateToProps({immerseMeApp})
{  
    return {
		open : immerseMeApp.product.propertyDialog.open,
		properties : immerseMeApp.product.properties,
		propertyLabels : immerseMeApp.product.propertyLabels,
		propertyLabelSelected : immerseMeApp.product.propertyLabelSelected,
		propertySelected : immerseMeApp.product.propertySelected,
		propertyEdit: immerseMeApp.product.propertyEdit,	
    }
}
