...
{
    return {
		labels : immerseMeApp.product.propertyLabels,
		propertyLabelFilterSelected : immerseMeApp.product.propertyLabelFilterSelected,
		properties : immerseMeApp.product.data.properties,
    }
}
