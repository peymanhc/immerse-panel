...
class TypesLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeTypesOrder,
        toggleOrderDescending: Actions.toggleTypesOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(TypesLabelToolbar);
