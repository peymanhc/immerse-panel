...
class NoteList extends Component {
    ...
    render()
    {
        const {variateDescSize, translate} = this.props;
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(NoteList)));
