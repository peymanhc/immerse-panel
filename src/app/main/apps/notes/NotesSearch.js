...
class NotesSearch extends Component {
    ...
    render()
    {
        const {classes, className, setSearchText, searchText, translate} = this.props;
...
export default withStyles(styles)(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(NotesSearch))));
