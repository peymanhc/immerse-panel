...
class NotesHeader extends Component {
    ...
    render()
    {
        const {pageLayout, variateDescSize, toggleVariateDescSize, translate} = this.props;
                ...
                <div className="flex flex-shrink items-center sm:w-224">
                    ...
                    <div className="flex items-center">
                        ...
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Typography variant="h6" className="hidden sm:flex">{translate('Notes')}</Typography>
                        </FuseAnimate>
                    </div>
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(NotesHeader));
