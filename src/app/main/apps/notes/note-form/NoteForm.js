                    ...
                    <div className="w-full">
                        {note.image && note.image !== "" && (
                            <div className="relative">
                                <img src={note.image} className="w-full block" alt={translate("note")}/>
                                <Fab
                        ...
                        <div className="p-16 pb-12">
                            <Input
                                placeholder={translate("Take_a_note")}
                                multiline
                                rows="4"
...
export default withRouter(withTranslate(NoteForm));
