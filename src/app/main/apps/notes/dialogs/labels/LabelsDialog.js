...
class LabelsDialog extends Component {
    ...
    render()
    {
        const {closeLabelsDialog, labelsDialogOpen, translate} = this.props;
        ...
        return (
            ...
            >
                <Typography className="text-16 mb-8 font-600">{translate('Edit_Labels')}</Typography>
                <List dense>
                    <ListItem
                        className="p-0 mb-16"
                        dense
                    >
                        ...
                        <Input
                            ...
                            placeholder={translate("Create_new_label")}
                        />
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(LabelsDialog));
