    ...
    render()
    {
        ...
        return (
            ...
            <div className="   flex-col md:flex-row">
                    ...
                    <div className="w-full md:max-w-256 mb-16 md:mb-0 flex flex-col items-center justify-center pb-24">
                        <Avatar className="w-96 h-96" alt="user avatar" src={this.state.avatar}/>
