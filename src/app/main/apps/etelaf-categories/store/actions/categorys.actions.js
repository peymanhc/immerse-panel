...
export const GET_CATEGORYS = '[ETELAF CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[ETELAF CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[ETELAF CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[ETELAF CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[ETELAF CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[ETELAF CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[ETELAF CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[ETELAF CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[ETELAF CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[ETELAF CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[ETELAF CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[ETELAF CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[ETELAF CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[ETELAF CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[ETELAF CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[ETELAF CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[ETELAF CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[ETELAF CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[ETELAF CATEGORY APP] GET TYPES';

export function getTypesC()
{
    const request = axios.get('/api/etelaf-category-app/types');
...
{
    const request = axios.get('/api/etelaf-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().etelafCategoryApp.categorys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/etelaf-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/etelaf-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/etelaf-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/etelaf-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/etelaf-category-app/remove-category', {data:{categoryId}});
