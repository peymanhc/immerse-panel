...
export const GET_ORDERS = '[E-EMMERSE APP] GET ORDERS';
export const SET_ORDERS_SEARCH_TEXT = '[E-EMMERSE APP] SET ORDERS SEARCH TEXT';
export const SET_ORDERS_STATUS_RADIO = '[E-EMMERSE APP] SET ORDERS STATUS RADIO';
export const OPEN_ORDERS_DIALOG = '[E-EMMERSE APP] OPEN ORDERS DIALOG';
export const CLOSE_ORDERS_DIALOG = '[E-EMMERSE APP] CLOSE ORDERS DIALOG';
export const GET_MASTERS = '[E-EMMERSE APP] GET MASTERS';
export const GET_ORDERS_STATUS = '[E-EMMERSE APP] GET ORDERS STATUS';
