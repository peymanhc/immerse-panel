...
export const GET_WARRANTYLISTSTATUS = '[E-EMMERSE APP] GET WARRANTYLISTSTATUS';
export const UPDATE_WARRANTYLISTSTATUS  = '[E-EMMERSE APP] UPDATE WARRANTYLISTSTATUS';
export const OPEN_NEW_WARRANTYLISTSTATUS_DIALOG = '[E-EMMERSE APP] OPEN NEW WARRANTYLISTSTATUS DIALOG';
export const CLOSE_NEW_WARRANTYLISTSTATUS_DIALOG = '[E-EMMERSE APP] CLOSE NEW WARRANTYLISTSTATUS DIALOG';
export const OPEN_EDIT_WARRANTYLISTSTATUS_DIALOG = '[E-EMMERSE APP] OPEN EDIT WARRANTYLISTSTATUS DIALOG';
export const CLOSE_EDIT_WARRANTYLISTSTATUS_DIALOG = '[E-EMMERSE APP] CLOSE EDIT WARRANTYLISTSTATUS DIALOG';
export const SET_WARRANTYLISTSTATUS_SEARCH_TEXT = '[E-EMMERSE APP] SET WARRANTYLISTSTATUS SEARCH TEXT';
export const TOGGLE_WARRANTYLISTSTATUS_WARRANTY_DESCENDING = '[E-EMMERSE APP] TOGGLE WARRANTYLISTSTATUS WARRANTY DESCENDING';
export const CHANGE_WARRANTYLISTSTATUS_WARRANTY = '[E-EMMERSE APP] CHANGE WARRANTYLISTSTATUS WARRANTY';
export const TOGGLE_STARRED = '[E-EMMERSE APP] TOGGLE WARRANTYLISTSTATUS STARRED';
export const TOGGLE_IMPORTANT = '[E-EMMERSE APP] TOGGLE WARRANTYLISTSTATUS IMPORTANT';
export const TOGGLE_ENABLE = '[E-EMMERSE APP] TOGGLE WARRANTYLISTSTATUS ENABLE';
export const TOGGLE_DISABLE = '[E-EMMERSE APP] TOGGLE WARRANTYLISTSTATUS DISABLE';
export const ADD_WARRANTYLISTSTATUS = '[E-EMMERSE APP] ADD WARRANTYLISTSTATUS';
export const REMOVE_WARRANTYLISTSTATUS = '[E-EMMERSE APP] REMOVE WARRANTYLISTSTATUS';
export const WAIT_WARRANTYLISTSTATUS = '[E-EMMERSE APP] ADD LOADING WARRANTYLISTSTATUS';
