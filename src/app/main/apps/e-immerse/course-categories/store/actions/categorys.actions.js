...
export const GET_CATEGORYS = '[COURSE CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[COURSE CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[COURSE CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[COURSE CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[COURSE CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[COURSE CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[COURSE CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[COURSE CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[COURSE CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[COURSE CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[COURSE CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[COURSE CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[COURSE CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[COURSE CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[COURSE CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[COURSE CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[COURSE CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[COURSE CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[COURSE CATEGORY APP] GET TYPES';

export function getTypesC()
{
    const request = axios.get('/api/course-category-app/types');
...
{
    const request = axios.get('/api/course-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().courseCategoryApp.categorys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/course-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/course-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/course-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/course-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/course-category-app/remove-category', {data:{categoryId}});
