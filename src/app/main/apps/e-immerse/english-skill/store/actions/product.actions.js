...
{
    const request = axios.get('/api/english-app/category-labels' , {params:{type:'skill'}});
...
{
    const request = axios.get('/api/english-app/types');
...
{
    const request = axios.get('/api/english-app/property-labels'  , {params:{type:'skill'}});
...
{
    const request = axios.get('/api/english-app/categories' , {params:{type:'skill'}});
...
{
    const request = axios.get('/api/english-app/properties', {params:{type:'skill'}});
...
{
    const request = axios.get('/api/english-app/clusterlist');
...
{
    const request = axios.get('/api/english-app/masterlist');
...
{
    const request = axios.get('/api/english-app/product', {params});
	...
	return (dispatch) => {
		...
		const uploadImage = (file, id) => {	
			return new Promise((resolve, reject) => {
				...
				if(productId === 'new') 
					axios.post('/api/english-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 
				else
					axios.put('/api/english-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
			});
		};
		...
		return saveImage(images).then((images) => {
			...
			let request = null;      form.type = "skill";
			if(productId === 'new')
				request = axios.post('/api/english-app/product/create', form);		
			else
				request = axios.put('/api/english-app/product/save', form);
