...
export const GET_PROPERTYLABELS = '[ENGLISH SKILL PROPERTY APP] GET PROPERTYLABELS';
export const UPDATE_PROPERTYLABELS  = '[ENGLISH SKILL PROPERTY APP] UPDATE PROPERTYLABELS';
export const OPEN_NEW_PROPERTYLABELS_DIALOG = '[ENGLISH SKILL PROPERTY APP] OPEN NEW PROPERTYLABELS DIALOG';
export const CLOSE_NEW_PROPERTYLABELS_DIALOG = '[ENGLISH SKILL PROPERTY APP] CLOSE NEW PROPERTYLABELS DIALOG';
export const OPEN_EDIT_PROPERTYLABELS_DIALOG = '[ENGLISH SKILL PROPERTY APP] OPEN EDIT PROPERTYLABELS DIALOG';
export const CLOSE_EDIT_PROPERTYLABELS_DIALOG = '[ENGLISH SKILL PROPERTY APP] CLOSE EDIT PROPERTYLABELS DIALOG';
export const SET_PROPERTYLABELS_SEARCH_TEXT = '[ENGLISH SKILL PROPERTY APP] SET PROPERTYLABELS SEARCH TEXT';
export const TOGGLE_PROPERTYLABELS_ORDER_DESCENDING = '[ENGLISH SKILL PROPERTY APP] TOGGLE PROPERTYLABELS ORDER DESCENDING';
export const CHANGE_PROPERTYLABELS_ORDER = '[ENGLISH SKILL PROPERTY APP] CHANGE PROPERTYLABELS ORDER';
export const TOGGLE_STARRED = '[ENGLISH SKILL PROPERTY APP] TOGGLE PROPERTYLABELS STARRED';
export const TOGGLE_IMPORTANT = '[ENGLISH SKILL PROPERTY APP] TOGGLE PROPERTYLABELS IMPORTANT';
export const TOGGLE_ENABLE = '[ENGLISH SKILL PROPERTY APP] TOGGLE PROPERTYLABELS ENABLE';
export const TOGGLE_DISABLE = '[ENGLISH SKILL PROPERTY APP] TOGGLE PROPERTYLABELS DISABLE';
export const ADD_PROPERTYLABELS = '[ENGLISH SKILL PROPERTY APP] ADD PROPERTYLABELS';
export const REMOVE_PROPERTYLABELS = '[ENGLISH SKILL PROPERTY APP] REMOVE PROPERTYLABELS';
export const WAIT_PROPERTYLABELS = '[ENGLISH SKILL PROPERTY APP] ADD LOADING PROPERTYLABELS';
...
export function updatePropertyLabel(property)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, 'put').then((images) => { 
			...
			//console.log(property);
			const request = axios.put('/api/english-skill-property-app/update-property-label', property);
...
{
    const request = axios.delete('/api/english-skill-property-app/remove-property-label', {data: {propertyId}});
