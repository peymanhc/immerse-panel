...
export const GET_PROPERTYS = '[ENGLISH SKILL PROPERTY APP] GET PROPERTYS';
export const UPDATE_PROPERTYS = '[ENGLISH SKILL PROPERTY APP] UPDATE PROPERTYS';
export const TOGGLE_STARRED = '[ENGLISH SKILL PROPERTY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[ENGLISH SKILL PROPERTY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[ENGLISH SKILL PROPERTY APP] TOGGLE IMPORTANT';
export const UPDATE_PROPERTY = '[ENGLISH SKILL PROPERTY APP] UPDATE PROPERTY';
export const ADD_PROPERTY = '[ENGLISH SKILL PROPERTY APP] ADD PROPERTY';
export const REMOVE_PROPERTY = '[ENGLISH SKILL PROPERTY APP] REMOVE PROPERTY';
export const SET_SEARCH_TEXT = '[ENGLISH SKILL PROPERTY APP] SET SEARCH TEXT';
export const OPEN_NEW_PROPERTY_DIALOG = '[ENGLISH SKILL PROPERTY APP] OPEN NEW PROPERTY DIALOG';
export const CLOSE_NEW_PROPERTY_DIALOG = '[ENGLISH SKILL PROPERTY APP] CLOSE NEW PROPERTY DIALOG';
export const OPEN_EDIT_PROPERTY_DIALOG = '[ENGLISH SKILL PROPERTY APP] OPEN EDIT PROPERTY DIALOG';
export const CLOSE_EDIT_PROPERTY_DIALOG = '[ENGLISH SKILL PROPERTY APP] CLOSE EDIT PROPERTY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[ENGLISH SKILL PROPERTY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[ENGLISH SKILL PROPERTY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[ENGLISH SKILL PROPERTY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[ENGLISH SKILL PROPERTY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_PROPERTY = '[ENGLISH SKILL PROPERTY APP] ADD LOADING PROPERTY';
...
{
    const request = axios.get('/api/english-skill-property-app/properties', {
        params: match.params
    });
...
export function updatePropertys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().englishSkillPropertyApp.propertys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === 'post')
			axios.post('/api/english-skill-property-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	
		else
			axios.put('/api/english-skill-property-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateProperty(property)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, 'put').then((images) => { 
			...
			//console.log(property);
			const request = axios.put('/api/english-skill-property-app/update-property', property);
...
export function addProperty(property)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, 'post').then((images) => { 
			...
			delete property.images;	
			//console.log(property);
			const request = axios.post('/api/english-skill-property-app/new-property', property);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/english-skill-property-app/remove-property', {data:{propertyId}});
