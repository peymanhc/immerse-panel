...
export const GET_CATEGORYLABELS = '[IMTV CATEGORY APP] GET CATEGORYLABELS';
export const UPDATE_CATEGORYLABELS  = '[IMTV CATEGORY APP] UPDATE CATEGORYLABELS';
export const OPEN_NEW_CATEGORYLABELS_DIALOG = '[IMTV CATEGORY APP] OPEN NEW CATEGORYLABELS DIALOG';
export const CLOSE_NEW_CATEGORYLABELS_DIALOG = '[IMTV CATEGORY APP] CLOSE NEW CATEGORYLABELS DIALOG';
export const OPEN_EDIT_CATEGORYLABELS_DIALOG = '[IMTV CATEGORY APP] OPEN EDIT CATEGORYLABELS DIALOG';
export const CLOSE_EDIT_CATEGORYLABELS_DIALOG = '[IMTV CATEGORY APP] CLOSE EDIT CATEGORYLABELS DIALOG';
export const SET_CATEGORYLABELS_SEARCH_TEXT = '[IMTV CATEGORY APP] SET CATEGORYLABELS SEARCH TEXT';
export const TOGGLE_CATEGORYLABELS_ORDER_DESCENDING = '[IMTV CATEGORY APP] TOGGLE CATEGORYLABELS ORDER DESCENDING';
export const CHANGE_CATEGORYLABELS_ORDER = '[IMTV CATEGORY APP] CHANGE CATEGORYLABELS ORDER';
export const TOGGLE_STARRED = '[IMTV CATEGORY APP] TOGGLE CATEGORYLABELS STARRED';
export const TOGGLE_IMPORTANT = '[IMTV CATEGORY APP] TOGGLE CATEGORYLABELS IMPORTANT';
export const TOGGLE_ENABLE = '[IMTV CATEGORY APP] TOGGLE CATEGORYLABELS ENABLE';
export const TOGGLE_DISABLE = '[IMTV CATEGORY APP] TOGGLE CATEGORYLABELS DISABLE';
export const ADD_CATEGORYLABELS = '[IMTV CATEGORY APP] ADD CATEGORYLABELS';
export const REMOVE_CATEGORYLABELS = '[IMTV CATEGORY APP] REMOVE CATEGORYLABELS';
export const WAIT_CATEGORYLABELS = '[IMTV CATEGORY APP] ADD LOADING CATEGORYLABELS';
export const GET_TYPES = '[IMTV CATEGORY APP] GET TYPES';

export function getTypes()
{
    const request = axios.get('/api/imtv-category-app/types');
...
{
    const request = axios.get('/api/imtv-category-app/labels');
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/imtv-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/imtv-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategoryLabel(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/imtv-category-app/update-category-label', category);
...
export function addCategoryLabels(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/imtv-category-app/new-label', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/imtv-category-app/remove-category-label', {data: {categoryId}});
