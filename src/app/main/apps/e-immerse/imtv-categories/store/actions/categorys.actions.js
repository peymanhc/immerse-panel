...
export const GET_CATEGORYS = '[IMTV CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[IMTV CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[IMTV CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[IMTV CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[IMTV CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[IMTV CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[IMTV CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[IMTV CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[IMTV CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[IMTV CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[IMTV CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[IMTV CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[IMTV CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[IMTV CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[IMTV CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[IMTV CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[IMTV CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[IMTV CATEGORY APP] ADD LOADING CATEGORY';
...
{
    const request = axios.get('/api/imtv-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().imtvCategoryApp.categorys;
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/imtv-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/imtv-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/imtv-category-app/remove-category', {data:{categoryId}});
