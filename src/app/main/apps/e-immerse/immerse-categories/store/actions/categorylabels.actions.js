...
export const GET_CATEGORYLABELS = '[IMMERSE CATEGORY APP] GET CATEGORYLABELS';
export const UPDATE_CATEGORYLABELS  = '[IMMERSE CATEGORY APP] UPDATE CATEGORYLABELS';
export const OPEN_NEW_CATEGORYLABELS_DIALOG = '[IMMERSE CATEGORY APP] OPEN NEW CATEGORYLABELS DIALOG';
export const CLOSE_NEW_CATEGORYLABELS_DIALOG = '[IMMERSE CATEGORY APP] CLOSE NEW CATEGORYLABELS DIALOG';
export const OPEN_EDIT_CATEGORYLABELS_DIALOG = '[IMMERSE CATEGORY APP] OPEN EDIT CATEGORYLABELS DIALOG';
export const CLOSE_EDIT_CATEGORYLABELS_DIALOG = '[IMMERSE CATEGORY APP] CLOSE EDIT CATEGORYLABELS DIALOG';
export const SET_CATEGORYLABELS_SEARCH_TEXT = '[IMMERSE CATEGORY APP] SET CATEGORYLABELS SEARCH TEXT';
export const TOGGLE_CATEGORYLABELS_ORDER_DESCENDING = '[IMMERSE CATEGORY APP] TOGGLE CATEGORYLABELS ORDER DESCENDING';
export const CHANGE_CATEGORYLABELS_ORDER = '[IMMERSE CATEGORY APP] CHANGE CATEGORYLABELS ORDER';
export const TOGGLE_STARRED = '[IMMERSE CATEGORY APP] TOGGLE CATEGORYLABELS STARRED';
export const TOGGLE_IMPORTANT = '[IMMERSE CATEGORY APP] TOGGLE CATEGORYLABELS IMPORTANT';
export const TOGGLE_ENABLE = '[IMMERSE CATEGORY APP] TOGGLE CATEGORYLABELS ENABLE';
export const TOGGLE_DISABLE = '[IMMERSE CATEGORY APP] TOGGLE CATEGORYLABELS DISABLE';
export const ADD_CATEGORYLABELS = '[IMMERSE CATEGORY APP] ADD CATEGORYLABELS';
export const REMOVE_CATEGORYLABELS = '[IMMERSE CATEGORY APP] REMOVE CATEGORYLABELS';
export const WAIT_CATEGORYLABELS = '[IMMERSE CATEGORY APP] ADD LOADING CATEGORYLABELS';
...
export function updateCategoryLabel(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/immerse-category-app/update-category-label', category);
...
{
    const request = axios.delete('/api/immerse-category-app/remove-category-label', {data: {categoryId}});
