...
export const GET_CATEGORYS = '[IMMERSE CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[IMMERSE CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[IMMERSE CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[IMMERSE CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[IMMERSE CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[IMMERSE CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[IMMERSE CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[IMMERSE CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[IMMERSE CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[IMMERSE CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[IMMERSE CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[IMMERSE CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[IMMERSE CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[IMMERSE CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[IMMERSE CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[IMMERSE CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[IMMERSE CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[IMMERSE CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[IMMERSE CATEGORY APP] GET TYPES';

export function getTypesC()
{
    const request = axios.get('/api/immerse-category-app/types');
...
{
    const request = axios.get('/api/immerse-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().immerseCategoryApp.categorys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/immerse-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/immerse-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/immerse-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/immerse-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/immerse-category-app/remove-category', {data:{categoryId}});
