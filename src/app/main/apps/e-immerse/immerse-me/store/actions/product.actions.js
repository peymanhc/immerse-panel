...
{
    const request = axios.get('/api/immerse-app/category-labels' , {params:{type:'immerse'}});
...
{
    const request = axios.get('/api/immerse-app/types');
...
{
    const request = axios.get('/api/immerse-app/property-labels' , {params:{type:'immerse'}});
...
{
    const request = axios.get('/api/immerse-app/categories' , {params:{type:'immerse'}});
...
{
    const request = axios.get('/api/immerse-app/properties'  , {params:{type:'immerse'}});
...
{
    const request = axios.get('/api/immerse-app/clusterlist');
...
{
    const request = axios.get('/api/immerse-app/masterlist');
...
{
    const request = axios.get('/api/immerse-app/product', {params});
	...
	return (dispatch) => {
		...
		const uploadImage = (file, id) => {	
			return new Promise((resolve, reject) => {
				...
				if(productId === 'new')
					axios.post('/api/immerse-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 
				else
					axios.put('/api/immerse-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
			});
		};
		...
		return saveImage(images).then((images) => {
			...
			let request = null;     form.type = "immerse";
			if(productId === 'new')
				request = axios.post('/api/immerse-app/product/create', form);		
			else
				request = axios.put('/api/immerse-app/product/save', form);
