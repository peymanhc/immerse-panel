                        ...
                        <Button
							...
							onClick={()=> {
								...
								const {PropertyId, PropertyName, PropertyPrice, PropertyPercent, PropertyDescription, 
									PropertyIcon, PropertyLabelId, PropertyLabelName, voicelink,codeColor, isColor, showType} = this.props.propertySelected;
								const row = {id, PropertyId, PropertyName, PropertyPrice, PropertyPercent, PropertyDescription, 
									PropertyIcon, PropertyLabelId, PropertyLabelName,voicelink, codeColor, isColor, showType}; 
								addNewProperty(row);
...
{  
    return {
		open : eCommerceApp.product.propertyDialog.open,
		properties : eCommerceApp.product.properties,
		propertyLabels : eCommerceApp.product.propertyLabels,
		propertyLabelSelected : eCommerceApp.product.propertyLabelSelected,
		propertySelected : eCommerceApp.product.propertySelected,
		propertyEdit: eCommerceApp.product.propertyEdit,	
    }
}
