...
class EnhancedTableHead extends React.Component {
  ...
  render() {
	...
	const rows = [
		...
		{ id: 'PropertyPrice', numeric: false, disablePadding: false, label: translate('Price_Percent') },
                ...
                .map(n => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>
                          {parseInt(n.PropertyPrice)}  
                          {n.PropertyPercent}</TableCell> 
                      <TableCell> 
                       <Typography
                    color="textSecondary"
                    className="property-notes truncate"
                >
                    {_.truncate(n.PropertyDescription.replace(/<(?:.|\n)*?>/gm, ''), {'length': 40})}
                </Typography>
...
{  
    return {
		product : eCommerceApp.product.data,
		propertyLabelFilterSelected : eCommerceApp.product.propertyLabelFilterSelected,
    }
}
