...
{
    return {
        orderBy        : englishSkillCategoryApp.categorys.orderBy,
        orderDescending: englishSkillCategoryApp.categorys.orderDescending
    }
}

export default withRouter(connect(mapStateToProps, mapDispatchToProps)(CategoryToolbar));
