...
class CategoryDialog extends Component {
    ...
    render()
    {
        const {categoryDialog, addCategory, updateCategory, removeCategory, labels, classes, types} = this.props;
...
{
    return {
        categoryDialog	: englishSkillCategoryApp.categorys.categoryDialog,
        labels    		: englishSkillCategoryApp.labels,
		loading			: englishSkillCategoryApp.categorys.loading,
		types			: englishSkillCategoryApp.categorylabels.types,
    }
}
