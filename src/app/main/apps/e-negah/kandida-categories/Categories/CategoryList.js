...
{
    return {
        categorys          : kandidaCategoryApp.categorys.entities,
        searchText     : kandidaCategoryApp.categorys.searchText,
        orderBy        : kandidaCategoryApp.categorys.orderBy,
        orderDescending: kandidaCategoryApp.categorys.orderDescending
    }
}
