...
{
    return {
        categoryDialog	: bookstoreCategoryApp.categorys.categoryDialog,
        labels    		: bookstoreCategoryApp.labels,
		loading			: bookstoreCategoryApp.categorys.loading,
		//types			: bookstoreCategoryApp.categorylabels.types,
    }
}
