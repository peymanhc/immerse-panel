...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/e-negah/tourism/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : tourismApp.posts.data,
        searchText: tourismApp.posts.searchText,
		postsCount: tourismApp.posts.count,
    }
}
