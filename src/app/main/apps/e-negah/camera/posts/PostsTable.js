...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/e-negah/camera/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : cameraApp.posts.data,
        searchText: cameraApp.posts.searchText,
		postsCount: cameraApp.posts.count,
    }
}
