...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/e-negah/bookstore/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : bookstoreApp.posts.data,
        searchText: bookstoreApp.posts.searchText,
		postsCount: bookstoreApp.posts.count,
    }
}
