...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/e-negah/etelaf/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : etelafApp.posts.data,
        searchText: etelafApp.posts.searchText,
		postsCount: etelafApp.posts.count,
    }
}
