...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/e-negah/kandida/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : kandidaApp.posts.data,
        searchText: kandidaApp.posts.searchText,
		postsCount: kandidaApp.posts.count,
    }
}
