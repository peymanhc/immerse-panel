...
const postReducer = function (state = initialState, action) {
    switch ( action.type )
    {
        ...
        case Actions.GET_CATEGORY_LABELS:
        {
          ...
          case Actions.GET_CITYSTATE_LABELS:
        {
            return {
                ...state,
                cityStateLabels: action.payload,
            };
        }      
        ...
        case Actions.GET_CATEGORIES:
        {
         ...
         case Actions.GET_CITYSTATES:
        {
            return {
                ...state,
                cityStates: action.payload,
            };
        }        
   ...
   case Actions.OPEN_NEW_CITYSTATE_DIALOG:
        {
            return {
                ...state,
                cityStateDialog: {
        ...
        case Actions.CLOSE_NEW_CATEGORY_DIALOG:
        {
            ...
            case Actions.CLOSE_NEW_CITYSTATE_DIALOG:
        {
            return {
                ...state,
                cityStateDialog: {
