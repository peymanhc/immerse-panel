...
export const GET_CATEGORYS = '[BLOG CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[BLOG CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[BLOG CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[BLOG CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[BLOG CATEGORY APP] TOGGLE IMPORTANT';
export const UPDATE_CATEGORY = '[BLOG CATEGORY APP] UPDATE CATEGORY';
export const ADD_CATEGORY = '[BLOG CATEGORY APP] ADD CATEGORY';
export const REMOVE_CATEGORY = '[BLOG CATEGORY APP] REMOVE CATEGORY';
export const SET_SEARCH_TEXT = '[BLOG CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[BLOG CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[BLOG CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[BLOG CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[BLOG CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[BLOG CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[BLOG CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[BLOG CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[BLOG CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[BLOG CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[BLOG CATEGORY APP] GET TYPES';

export function getTypesC()
{
    const request = axios.get('/api/notebook-category-app/types');
...
{
    const request = axios.get('/api/notebook-category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().notebookCategoryApp.categorys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/notebook-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/notebook-category-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/notebook-category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/notebook-category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/notebook-category-app/remove-category', {data:{categoryId}});
