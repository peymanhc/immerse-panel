...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/e-negah/notebook/posts/' + item.id + '/' + item.name);
    };
...
{
    return {
        posts  : notebookApp.posts.data,
        searchText: notebookApp.posts.searchText,
		postsCount: notebookApp.posts.count,
    }
}
