...
class OrderShowStatusDialog extends Component {


    render()
    {
        const {orderStatus, translate, classes, status} = this.props; 
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, null)(withTranslate(OrderShowStatusDialog)));
