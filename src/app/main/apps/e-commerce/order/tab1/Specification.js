...
import { withStyles,Icon,  Typography, Avatar, IconButton, TextField} from '@material-ui/core';
...
const Specification = ({classes,translate, order, openAddUserDialog, status, companies, addDataToOrder }) => {
...
{
    return {
		status		: eCommerceApp.newOrder.status,
		companies	: eCommerceApp.newOrder.companies,
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(withStyles(styles)(withTranslate(Specification)));