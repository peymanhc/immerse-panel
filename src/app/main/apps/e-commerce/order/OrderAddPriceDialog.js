...
class AddPriceDialog extends Component {
    ...
    {
        if ( !prevProps.orderAddPriceDialog.open && this.props.orderAddPriceDialog.open )
        {
    ...
    render()
    {
        const {orderAddPriceDialog, saveOrder, closeAddPriceDialog, translate, userId} = this.props; 
...
{ 
    return {
		orderAddPriceDialog	: eCommerceApp.order.orderAddPriceDialog,
