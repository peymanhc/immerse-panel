...
class OrdersStatusLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeOrdersStatusOrder,
        toggleOrderDescending: Actions.toggleOrdersStatusOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(OrdersStatusLabelToolbar));
