...
export const CLOSE_ADD_ORDER_STATUS_DIALOG = '[E-COMMERCE APP] CLOSE ADD ORDER STATUS DIALOG';
export const OPEN_ADD_ORDER_STATUS_DIALOG = '[E-COMMERCE APP] OPEN ADD ORDER STATUS DIALOG';
export const CLOSE_ADD_ORDER_PRICE_DIALOG = '[E-COMMERCE APP] CLOSE ADD ORDER PRICE DIALOG';
export const OPEN_ADD_ORDER_PRICE_DIALOG = '[E-COMMERCE APP] OPEN ADD ORDER PRICE DIALOG';
export const CLOSE_ORDER_SHOW_IMAGE_DIALOG = '[E-COMMERCE APP] CLOSE ORDER SHOW IMAGE DIALOG';
export const OPEN_ORDER_SHOW_IMAGE_DIALOG = '[E-COMMERCE APP] OPEN ORDER SHOW IMAGE DIALOG';
export const GET_ORDER_STATUS = '[E-COMMERCE APP] GET ORDER STATUS';
export const WAIT_ORDER_STATUS = '[E-COMMERCE APP] WAIT_ORDER_STATUS';
