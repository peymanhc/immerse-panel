...
import {GET_CONTACTS, REMOVE_SELECTED_CONTACT_ID} from 'app/main/apps/chat/store/actions';
...
export const USER_ACCESS_DENIED_START = '[USER] ACCESS DENIED START';
export const USER_ACCESS_DENIED_END = '[USER] ACCESS DENIED END';

export function startAceccDeniedRedirect () {
    return {
        type: USER_ACCESS_DENIED_START
    }
}

export function endAceccDeniedRedirect () {
    return {
        type: USER_ACCESS_DENIED_END
    }	
}
...
export function setUserData(user)
{
    return (dispatch) => {
		...
		const locale = user.data.settings.locale;
		if(locale)
			dispatch(setPanelLocale(locale));
        /*
        Set User Data
         */
        dispatch({
