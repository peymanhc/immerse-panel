...
export const CLOSE_ADD_WARRANTY_USER_DIALOG	= '[E-COMMERCE APP] CLOSE ADD WARRANTY USER DIALOG';
export const OPEN_ADD_WARRANTY_USER_DIALOG		= '[E-COMMERCE APP] OPEN ADD WARRANTY USER DIALOG';
export const CLOSE_ADD_WARRANTY_PRODUCT_DIALOG	= '[E-COMMERCE APP] CLOSE ADD WARRANTY PRODUCT DIALOG';
export const OPEN_ADD_WARRANTY_PRODUCT_DIALOG	= '[E-COMMERCE APP] OPEN ADD WARRANTY PRODUCT DIALOG';
export const CLOSE_ADD_WARRANTY_DISCOUNT_DIALOG= '[E-COMMERCE APP] CLOSE ADD WARRANTY DISCOUNT DIALOG';
export const OPEN_ADD_WARRANTY_DISCOUNT_DIALOG	= '[E-COMMERCE APP] OPEN ADD WARRANTY DISCOUNT DIALOG';
export const CLOSE_ADD_WARRANTY_TAX_DIALOG		= '[E-COMMERCE APP] CLOSE ADD WARRANTY TAX DIALOG';
export const OPEN_ADD_WARRANTY_TAX_DIALOG		= '[E-COMMERCE APP] OPEN ADD WARRANTY TAX DIALOG';
export const NEW_WARRANTY_GET_USERS 			= '[E-COMMERCE APP] NEW WARRANTY GET USERS';
export const NEW_WARRANTY_GET_ADDRESSES 		= '[E-COMMERCE APP] NEW WARRANTY GET ADDRESSES';
export const WAIT_NEW_WARRANTY_ADD_USER		= '[E-COMMERCE APP] WAIT NEW WARRANTY ADD USER';
export const NEW_WARRANTY_GET_STATUS 			= '[E-COMMERCE APP] NEW WARRANTY GET STATUS ';
export const NEW_WARRANTY_GET_COMPANIS			= '[E-COMMERCE APP] NEW WARRANTY GET COMPANIS';
export const NEW_WARRANTY_GET_PRODUCTS			= '[E-COMMERCE APP] NEW WARRANTY GET PRODUCTS';
export const NEW_WARRANTY_ADD_DISCOUNT			= '[E-COMMERCE APP] NEW WARRANTY ADD DISCOUNT';
export const NEW_WARRANTY_DELETE_DISCOUNT		= '[E-COMMERCE APP] NEW WARRANTY DELETE DISCOUNT';
export const NEW_WARRANTY_GET_DISCOUNTS		= '[E-COMMERCE APP] NEW WARRANTY GET DISCOUNTS';
export const NEW_WARRANTY_GET_TAX				= '[E-COMMERCE APP] NEW WARRANTY GET TAX';
export const NEW_WARRANTY_ADD_TAX				= '[E-COMMERCE APP] NEW WARRANTY ADD TAX';
export const NEW_WARRANTY_DELETE_TAX			= '[E-COMMERCE APP] NEW WARRANTY DELETE TAX';
export const NEW_WARRANTY_CREART_WARRANTY			= '[E-COMMERCE APP] NEW WARRANTY CREART WARRANTY';
