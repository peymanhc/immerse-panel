...
export const GET_WARRANTYLIST = '[E-COMMERCE APP] GET WARRANTYLIST';
export const SET_WARRANTYLIST_SEARCH_TEXT = '[E-COMMERCE APP] SET WARRANTYLIST SEARCH TEXT';
export const SET_WARRANTYLIST_STATUS_RADIO = '[E-COMMERCE APP] SET WARRANTYLIST STATUS RADIO';
export const OPEN_WARRANTYLIST_DIALOG = '[E-COMMERCE APP] OPEN WARRANTYLIST DIALOG';
export const CLOSE_WARRANTYLIST_DIALOG = '[E-COMMERCE APP] CLOSE WARRANTYLIST DIALOG';
export const GET_MASTERS = '[E-COMMERCE APP] GET MASTERS';
export const GET_WARRANTYLIST_STATUS = '[E-COMMERCE APP] GET WARRANTYLIST STATUS';
