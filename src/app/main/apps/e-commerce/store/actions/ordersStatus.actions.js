...
export const GET_ORDERSSTATUS = '[E-COMMERCE APP] GET ORDERSSTATUS';
export const UPDATE_ORDERSSTATUS  = '[E-COMMERCE APP] UPDATE ORDERSSTATUS';
export const OPEN_NEW_ORDERSSTATUS_DIALOG = '[E-COMMERCE APP] OPEN NEW ORDERSSTATUS DIALOG';
export const CLOSE_NEW_ORDERSSTATUS_DIALOG = '[E-COMMERCE APP] CLOSE NEW ORDERSSTATUS DIALOG';
export const OPEN_EDIT_ORDERSSTATUS_DIALOG = '[E-COMMERCE APP] OPEN EDIT ORDERSSTATUS DIALOG';
export const CLOSE_EDIT_ORDERSSTATUS_DIALOG = '[E-COMMERCE APP] CLOSE EDIT ORDERSSTATUS DIALOG';
export const SET_ORDERSSTATUS_SEARCH_TEXT = '[E-COMMERCE APP] SET ORDERSSTATUS SEARCH TEXT';
export const TOGGLE_ORDERSSTATUS_ORDER_DESCENDING = '[E-COMMERCE APP] TOGGLE ORDERSSTATUS ORDER DESCENDING';
export const CHANGE_ORDERSSTATUS_ORDER = '[E-COMMERCE APP] CHANGE ORDERSSTATUS ORDER';
export const TOGGLE_STARRED = '[E-COMMERCE APP] TOGGLE ORDERSSTATUS STARRED';
export const TOGGLE_IMPORTANT = '[E-COMMERCE APP] TOGGLE ORDERSSTATUS IMPORTANT';
export const TOGGLE_ENABLE = '[E-COMMERCE APP] TOGGLE ORDERSSTATUS ENABLE';
export const TOGGLE_DISABLE = '[E-COMMERCE APP] TOGGLE ORDERSSTATUS DISABLE';
export const ADD_ORDERSSTATUS = '[E-COMMERCE APP] ADD ORDERSSTATUS';
export const REMOVE_ORDERSSTATUS = '[E-COMMERCE APP] REMOVE ORDERSSTATUS';
export const WAIT_ORDERSSTATUS = '[E-COMMERCE APP] ADD LOADING ORDERSSTATUS';
