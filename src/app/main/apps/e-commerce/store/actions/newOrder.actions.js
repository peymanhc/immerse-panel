...
export const CLOSE_ADD_ORDER_USER_DIALOG	= '[E-COMMERCE APP] CLOSE ADD ORDER USER DIALOG';
export const OPEN_ADD_ORDER_USER_DIALOG		= '[E-COMMERCE APP] OPEN ADD ORDER USER DIALOG';
export const CLOSE_ADD_ORDER_PRODUCT_DIALOG	= '[E-COMMERCE APP] CLOSE ADD ORDER PRODUCT DIALOG';
export const OPEN_ADD_ORDER_PRODUCT_DIALOG	= '[E-COMMERCE APP] OPEN ADD ORDER PRODUCT DIALOG';
export const CLOSE_ADD_ORDER_DISCOUNT_DIALOG= '[E-COMMERCE APP] CLOSE ADD ORDER DISCOUNT DIALOG';
export const OPEN_ADD_ORDER_DISCOUNT_DIALOG	= '[E-COMMERCE APP] OPEN ADD ORDER DISCOUNT DIALOG';
export const CLOSE_ADD_ORDER_TAX_DIALOG		= '[E-COMMERCE APP] CLOSE ADD ORDER TAX DIALOG';
export const OPEN_ADD_ORDER_TAX_DIALOG		= '[E-COMMERCE APP] OPEN ADD ORDER TAX DIALOG';
export const NEW_ORDER_GET_USERS 			= '[E-COMMERCE APP] NEW ORDER GET USERS';
export const NEW_ORDER_GET_ADDRESSES 		= '[E-COMMERCE APP] NEW ORDER GET ADDRESSES';
export const WAIT_NEW_ORDER_ADD_USER		= '[E-COMMERCE APP] WAIT NEW ORDER ADD USER';
export const NEW_ORDER_GET_STATUS 			= '[E-COMMERCE APP] NEW ORDER GET STATUS ';
export const NEW_ORDER_GET_COMPANIS			= '[E-COMMERCE APP] NEW ORDER GET COMPANIS';
export const NEW_ORDER_GET_PRODUCTS			= '[E-COMMERCE APP] NEW ORDER GET PRODUCTS';
export const NEW_ORDER_ADD_DISCOUNT			= '[E-COMMERCE APP] NEW ORDER ADD DISCOUNT';
export const NEW_ORDER_DELETE_DISCOUNT		= '[E-COMMERCE APP] NEW ORDER DELETE DISCOUNT';
export const NEW_ORDER_GET_DISCOUNTS		= '[E-COMMERCE APP] NEW ORDER GET DISCOUNTS';
export const NEW_ORDER_GET_TAX				= '[E-COMMERCE APP] NEW ORDER GET TAX';
export const NEW_ORDER_ADD_TAX				= '[E-COMMERCE APP] NEW ORDER ADD TAX';
export const NEW_ORDER_DELETE_TAX			= '[E-COMMERCE APP] NEW ORDER DELETE TAX';
export const NEW_ORDER_CREART_ORDER			= '[E-COMMERCE APP] NEW ORDER CREART ORDER';
