...
export const OPEN_PRODUCTS_EXCEL_DIALOG = '[E-COMMERCE APP] OPEN_PRODUCTS_EXCEL_DIALOG';
export const CLOSE_PRODUCTS_EXCEL_DIALOG = '[E-COMMERCE APP] CLOSE_PRODUCTS_EXCEL_DIALOG';
export const WAIT_PRODUCTS_EXCEL = '[E-COMMERCE APP] WAIT_PRODUCTS_EXCEL';
...
const uploadExcel = (file) => {	
	return new Promise((resolve, reject) => {
		...
		axios.post('/api/e-commerce-app/excel-upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
