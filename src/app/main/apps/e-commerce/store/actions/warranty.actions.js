...
export const GET_WARRANTY = '[E-COMMERCE APP] GET WARRANTY';
export const SAVE_WARRANTY = '[E-COMMERCE APP] SAVE WARRANTY';
export const CLOSE_ADD_WARRANTY_STATUS_DIALOG = '[E-COMMERCE APP] CLOSE ADD WARRANTY STATUS DIALOG';
export const OPEN_ADD_WARRANTY_STATUS_DIALOG = '[E-COMMERCE APP] OPEN ADD WARRANTY STATUS DIALOG';
export const CLOSE_ADD_WARRANTY_PRICE_DIALOG = '[E-COMMERCE APP] CLOSE ADD WARRANTY PRICE DIALOG';
export const OPEN_ADD_WARRANTY_PRICE_DIALOG = '[E-COMMERCE APP] OPEN ADD WARRANTY PRICE DIALOG';
export const CLOSE_WARRANTY_SHOW_IMAGE_DIALOG = '[E-COMMERCE APP] CLOSE WARRANTY SHOW IMAGE DIALOG';
export const OPEN_WARRANTY_SHOW_IMAGE_DIALOG = '[E-COMMERCE APP] OPEN WARRANTY SHOW IMAGE DIALOG';
export const GET_WARRANTY_STATUS = '[E-COMMERCE APP] GET WARRANTY STATUS';
export const WAIT_WARRANTY_STATUS = '[E-COMMERCE APP] WAIT_WARRANTY_STATUS';
