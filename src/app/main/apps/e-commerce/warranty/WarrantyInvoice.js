...
const WarrantyInvoice = ({classes, warranty, translate}) => {
                            ...
                            <Table className="inline-block mt-32 w-1/2">
                                <TableBody>
                                    <TableRow>
                                        ...
                                        <TableCell align="right">
                                            <Typography className="font-medium" variant="subtitle1" color="textSecondary">
                                                {formatter.format(warranty.subtotal)}
                                            </Typography>
                                        </TableCell>
                                    </TableRow>
                                    <TableRow>
                                    ...
                                    <TableRow>
                                        ...
                                        <TableCell align="right">
                                            <Typography className="font-medium" variant="subtitle1" color="textSecondary">
                                                {formatter.format(warranty.discount)}
                                            </Typography>
                                        </TableCell>
                                    </TableRow>
                                    <TableRow>
                                        ...
                                        <TableCell align="right">
                                            <Typography className="font-light" variant="h6" color="textSecondary">
                                                {formatter.format(warranty.total)}
                                            </Typography>
                                        </TableCell>
                                    </TableRow>
                                </TableBody> 
...
export default withStyles(styles, {withTheme: true})(withTranslate(withTranslate(WarrantyInvoice)));
