...
class WarrantyAddStatusDialog extends Component {
    ...
    addStatus = () => {
        const {warrantyId, addWarrantyToStatus} = this.props; 
        const { statusId, description, imgSrc1, imgSrc2} = this.state;      
        addWarrantyToStatus(warrantyId, statusId, imgSrc1, imgSrc2, description).then(() => {
    ...
    { 
        ...
        const {warrantyStatus, warrantyAddStatusDialog,  translate, classes} = this.props; 
        const { statusId, description, imgSrc1, imgSrc2} = this.state;
            ...
            >
                <AppBar position="static" elevation={1}>
                    <Toolbar className="block w-full p-24">
                        ...
                        <div className="flex-grow">
                            <CircularProgress 
                                className={this.props.statusWarrantyImageLoading? classes.loading:classes.hidden} 
                                color="secondary"
                            />
                    </div>
                    </Toolbar>
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        ...
        addWarrantyToStatus : Actions.addWarrantyToStatus,
    }, dispatch);
}
...
{ 
    return {
        ...
        warrantyAddStatusDialog : eCommerceApp.warranty.warrantyAddStatusDialog,
            statusWarrantyImageLoading : eCommerceApp.warranty.statusWarrantyImageLoading,                                                              
    }
}

export default withStyles(styles, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(withTranslate(WarrantyAddStatusDialog)));
