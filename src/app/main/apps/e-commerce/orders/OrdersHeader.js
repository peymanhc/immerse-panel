...
const OrdersHeader = ({setSearchText, searchText, mainTheme, translate}) => {
        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">{translate('Orders')}</Typography>
                </FuseAnimate>
            </div>
            ...
            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Button component={Link} to="/apps/e-commerce/orders/order/new" className="whitespace-no-wrap" variant="contained">
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(OrdersHeader));
