...
import ClusterProductAttachment from './ClusterProductAttachment';
import { withTranslate } from 'react-redux-multilingual';

class ClusterProductCompose extends Component {
            ...
            <div className="p-24">
                ...
                >
                    ...
                    <DialogContent classes={{root: "p-16 pb-0 sm:p-24 sm:pb-0"}}>
                        ...
                        <div className="pt-8">
                            <ClusterProductAttachment fileName="attachment-2.doc" size="12 kb"/>
                            <ClusterProductAttachment fileName="attachment-1.jpg" size="350 kb"/>
                        </div>
                    </DialogContent>
...
export default withTranslate(ClusterProductCompose);
