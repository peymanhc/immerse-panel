...
class DictionarysLabelToolbar extends Component {
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
        changeOrder          : Actions.changeDictionarysOrder,
        toggleOrderDescending: Actions.toggleDictionarysOrderDescending
    }, dispatch);
}
...
export default connect(mapStateToProps, mapDispatchToProps)(DictionarysLabelToolbar);