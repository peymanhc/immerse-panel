...
import * as Actions from '../store/actions/categorys.actions';
...
function mapDispatchToProps(dispatch)
{
    return bindActionCreators({
		...
		getClusterlistC		: Actions.getClusterlistC,		
    }, dispatch);
}


export default withReducer('CategoryApp', reducer)(withRouter(connect(null, mapDispatchToProps)(CategoryApp)));
