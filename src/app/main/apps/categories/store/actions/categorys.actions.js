...
export const GET_CATEGORYS = '[CATEGORY APP] GET CATEGORYS';
export const UPDATE_CATEGORYS = '[CATEGORY APP] UPDATE CATEGORYS';
export const TOGGLE_STARRED = '[CATEGORY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[CATEGORY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[CATEGORY APP] TOGGLE IMPORTANT';
...
export const SET_SEARCH_TEXT = '[CATEGORY APP] SET SEARCH TEXT';
export const OPEN_NEW_CATEGORY_DIALOG = '[CATEGORY APP] OPEN NEW CATEGORY DIALOG';
export const CLOSE_NEW_CATEGORY_DIALOG = '[CATEGORY APP] CLOSE NEW CATEGORY DIALOG';
export const OPEN_EDIT_CATEGORY_DIALOG = '[CATEGORY APP] OPEN EDIT CATEGORY DIALOG';
export const CLOSE_EDIT_CATEGORY_DIALOG = '[CATEGORY APP] CLOSE EDIT CATEGORY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[CATEGORY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[CATEGORY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[CATEGORY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[CATEGORY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_CATEGORY = '[CATEGORY APP] ADD LOADING CATEGORY';
export const GET_TYPES = '[CATEGORY APP] GET TYPES';
export const GET_ADSC = '[CATEGORY APP] GET_ADSC';

export function getClusterlistC()
{
...
{
    const request = axios.get('/api/category-app/categories', {
        params: match.params
    });
...
export function updateCategorys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().CategoryApp.categorys;
...
export function updateCategory(category)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, "put").then((images) => { 
			...
			//console.log(category);
			const request = axios.put('/api/category-app/update-category', category);
...
export function addCategory(category)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, "post").then((images) => { 
			...
			delete category.images;	
			//console.log(category);
			const request = axios.post('/api/category-app/new-category', category);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/category-app/remove-category', {data:{categoryId}});
