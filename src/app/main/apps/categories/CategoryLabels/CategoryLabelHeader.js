...
const CategoryLabelHeader = ({setSearchText, searchText, pageLayout, mainTheme, openNewCategoryDialog, translate}) => {
    return (
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(CategoryLabelHeader));
