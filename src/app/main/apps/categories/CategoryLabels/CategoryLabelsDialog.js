...
class CategoryDialog extends Component {
    ...
    render()
    {  
        const {categoryDialog, addCategory, updateCategory, removeCategory, classes, types, translate, clusterlist} = this.props;
		...
		if(form)
			selectedCluster = newClusterList.find(({id}) => id === form.clusterId);
                ...
                <AppBar position="static" elevation={1}>
                    <Toolbar className="flex w-full">
                        <Typography variant="subtitle1" color="inherit">
                            {categoryDialog.type === 'new' ? translate('New_Category_Label') : translate('Edit_Category_Label')}
                        </Typography>
						<div>
							<CircularProgress 
                ...
                <DialogContent classes={{root: "p-0"}}>
                    ...
                    <div className="px-16 sm:px-24">
						...
						<FuseChipSelect
							...
							value={selectedCluster ? {value:selectedCluster.id, label:selectedCluster.name} : null}
...
{
    return { 
        categoryDialog	: CategoryApp.categorylabels.categoryDialog,
		loading			: CategoryApp.categorylabels.loading,
		types			: CategoryApp.categorylabels.types,
		clusterlist			: CategoryApp.categorylabels.clusterlist,
    }
}
