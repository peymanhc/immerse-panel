...
export function updateContact(contact)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/contacts-app/update-contact', {
            contact
        });
...
export function removeContact(contactId)
{
    return (dispatch, getState) => {
        ...
        const request = axios.delete('/api/contacts-app/remove-contact', {data: {
            contactId
        }});
...
export function removeContacts(contactIds)
{
    return (dispatch, getState) => {
        ...
        const request = axios.delete('/api/contacts-app/remove-contacts', {data: {
            contactIds
        }});
...
export function toggleStarredContact(contactId)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/contacts-app/toggle-starred-contact', {
            contactId
        });
...
export function toggleStarredContacts(contactIds)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/contacts-app/toggle-starred-contacts', {
            contactIds
        });
...
export function setContactsStarred(contactIds)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/contacts-app/set-contacts-starred', {
            contactIds
        });
...
export function setContactsUnstarred(contactIds)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/contacts-app/set-contacts-unstarred', {
            contactIds
        });
