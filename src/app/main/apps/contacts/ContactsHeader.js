...
class ContactsHeader extends Component {
    ...
    render()
    {
        const {setSearchText, searchText, pageLayout, mainTheme, translate} = this.props;
                ...
                <div className="flex flex-shrink items-center sm:w-224">
                    ...
                    <div className="flex items-center">
                        ...
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Typography variant="h6" className="hidden sm:flex">{translate('Contacts')}</Typography>
                        </FuseAnimate>
                    </div>
                </div>
                    ...
                    <MuiThemeProvider theme={mainTheme}>
                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                            <Paper className="flex p-4 items-center w-full max-w-512 px-8 py-4" elevation={1}>
                                ...
                                <Input
                                    placeholder={translate('Search_for_anything')}
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(ContactsHeader));
