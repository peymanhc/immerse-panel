...
class ContactsList extends Component {
    ...
    render()
    {
        const { contacts, user, searchText, selectedContactIds, selectAllContacts, deSelectAllContacts, 
			toggleInSelectedContacts, openEditContactDialog, removeContacts, removeContact, toggleStarredContact, setContactsUnstarred, 
			setContactsStarred, translate
		} = this.props;
            ...
            return (
                <div className="flex items-center justify-center h-full">
                    <Typography color="textSecondary" variant="h5">
                        {translate('There_are_no_contacts')}
                    </Typography>
                </div>
            );
        }
                                        ...
                                        >
                                            <MenuList>
                                                ...
                                                >
                                                    ...
                                                    <ListItemText inset primary={translate('Remove')}/>
                                                </MenuItem>
                                                <MenuItem
                                                    onClick={() => {
                                                ...
                                                >
                                                    ...
                                                    <ListItemText inset primary={translate('Starred')}/>
                                                </MenuItem>
                                                <MenuItem
                                                    onClick={() => {
                                                ...
                                                >
                                                    ...
                                                    <ListItemText inset primary={translate('Unstarred')}/>
                                                </MenuItem>
                                            </MenuList>
                                        </Menu>
                                    </React.Fragment>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(ContactsList)));
