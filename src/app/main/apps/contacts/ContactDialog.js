...
class ContactDialog extends Component {
    ...
    render()
    {
        const {contactDialog, addContact, updateContact, removeContact, translate} = this.props;
                ...
                <AppBar position="static" elevation={1}>
                    <Toolbar className="flex w-full">
                        <Typography variant="subtitle1" color="inherit">
                            {contactDialog.type === 'new' ? translate('New_Contact') : translate('Edit_Contact')}
                        </Typography>
                    </Toolbar>
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(ContactDialog));
