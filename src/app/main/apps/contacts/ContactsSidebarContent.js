                    ...
                    <Paper elevation={1} className="rounded-8">
                        ...
                        <List>
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary={translate("All_contacts")} disableTypography={true}/>
                            </ListItem>
                            <ListItem
                                button
                                component={NavLink}
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary={translate("Frequently_contacted")} disableTypography={true}/>
                            </ListItem>
                            <ListItem
                                button
                                component={NavLink}
                            ...
                            >
                                ...
                                <ListItemText className="truncate pr-0" primary={translate("Starred_contacts")} disableTypography={true}/>
                            </ListItem>
                        </List>
                    </Paper>
                </FuseAnimate>
...
export default withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(ContactsSidebarContent))));
