...
class Post extends Component {
    ...
    render()
    {
		...
		if(form && form.id && form.name)
			postLink = window.location.origin + "/blog/post-full/" + form.id + "/" + form.name.split(' ').join('-');
                        ...
                        <div className="flex flex-1 w-full items-center justify-between">
                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/apps/blog/posts">
...
export default 
	withReducer('blogApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Post)))));
