                    ...
                    <Paper elevation={1} className="rounded-8">
						{
							...
							<div className="p-24 flex items-center">
								<Avatar className="mr-12" alt={country.name} src={country.avatar}/>
                        ...
                        <List>
                            <ListItem
                                button
                                component={NavLink}
                                to={'/apps/countries/managment'}
                                activeClassName="active"
                                className={classes.listItem}
                            >
                                <Icon className="list-item-icon text-16" color="action">people</Icon>
                                <ListItemText className="truncate pr-0" primary="All countries" disableTypography={true}/>
                            </ListItem>
                        </List>
                    </Paper>
                </FuseAnimate>
...
{
    return {
        //country: {name: 'Mohammad', avatar:'/assets/images/avatars/profile.jpg'},
		country: CountriesApp.countries.country,
    }
}
