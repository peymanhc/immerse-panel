...
{
    const request = axios.get('/api/gatewaysms-app/countries', {
        params: routeParams
    });
...
export function addCountry(newCountry)
{
    return async (dispatch, getState) => {
		...
		if(typeof image === "object"){
			try{
				const img = await uploadImage(image.file, "gatewaysms", "post"); 
        ...
        const request = axios.post('/api/gatewaysms-app/create-country', {
            country:newCountry
        });
...
export function updateCountry(country)
{
    return async (dispatch, getState) => {
		...
		if(typeof image === "object"){
			try{
				const img = await uploadImage(image.file, "gatewaysms", "put"); 
        ...
        const request = axios.put('/api/gatewaysms-app/save-country', {
            country
        });
...
export function removeCountry(countryId)
{
    return (dispatch, getState) => {
        ...
        const request = axios.delete('/api/gatewaysms-app/remove-countries', {
            data:{
...
export function toggleStarredCountry(countryId)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/gatewaysms-app/toggle-starred-countries', {
            countryIds:[countryId]
        });
...
export function setCountriesStarred(countryIds)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/gatewaysms-app/set-countries-starred', {
            countryIds
        });
...
export function setCountriesUnstarred(countryIds)
{
    return (dispatch, getState) => {
        ...
        const request = axios.put('/api/gatewaysms-app/set-countries-unstarred', {
            countryIds
        });
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === "post")
			axios.post('/api/gatewaysms-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));
		else
			axios.put('/api/gatewaysms-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
