...
{
    const request = axios.get('/api/gatewaysms-app/cities');
...
export function addCity(newCity)
{
    return async (dispatch, getState) => {
        ...
        const request = axios.post('/api/gatewaysms-app/create-city', {
            city:newCity
        });
...
export function updateCity(city)
{
    return async (dispatch, getState) => {
        ...
        const request = axios.put('/api/gatewaysms-app/save-city', {
            city
        });
...
export function removeCity(id)
{
    return (dispatch, getState) => {
        ...
        const request = axios.delete('/api/gatewaysms-app/remove-cities', {
            data:{
				cityIds  : [id],
			}
        });
