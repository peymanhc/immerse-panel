 ...
 ckEditorHandleChange = ( event, editor ) => {
    ...
    render()
    {
		...
		if(form && form.id && form.name)
			postLink = window.location.origin + "/camera/post-full/" + form.id + "/" + form.name.split(' ').join('-');
                        ...
                        <div className="flex flex-1 w-full items-center justify-between">
                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/apps/camera/posts">
...
function mapStateToProps({cameraApp})
{
    return {
        post: cameraApp.post
    }
...
export default 
	withReducer('cameraApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Post)))));
