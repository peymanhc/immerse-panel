...
class PropertyDialog extends Component {
    ...
    render()
    {
        const {propertyDialog, addProperty, updateProperty, removeProperty, classes} = this.props;
            ...
            <Dialog {...propertyDialog.props} onClose={this.closePropertyDialog} fullWidth maxWidth="sm">
                ...
                <AppBar position="static" elevation={1}>
                    <Toolbar className="flex w-full">
                        <Typography variant="subtitle1" color="inherit">
                            {propertyDialog.type === 'new' ? 'New Property Label' : 'Edit Property Label'}
                        </Typography>
						<div>
							<CircularProgress 
                ...
                <DialogContent classes={{root: "p-0"}}>
                    ...
                    <div className="px-16 sm:px-24">
						...
						<FormControlLabel
							control={
								<Checkbox checked={form.isColor} name="isColor" onChange={this.handleChange}  value="isColor" />
							}
							label="Is Color"
...
{
    return { 
        propertyDialog: englishSkillPropertyApp.propertylabels.propertyDialog,
		loading: englishSkillPropertyApp.propertylabels.loading
    }
}
