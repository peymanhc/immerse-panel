...
import {Icon, Table, TableBody, TableCell,Typography, TablePagination, TableRow, Checkbox} from '@material-ui/core';
...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/course/posts/' + item.id + '/' + item.name);
    };
                                        ...
                                        >
                                            ...
                                            <TableCell component="th" scope="row">
                                                 ...
                                                 <Typography color="textSecondary" className="truncate">
                                                  [{n.companyName}] {n.masterName} </Typography>
                                                </div>
                                            ...
                                            <TableCell component="th" scope="row" align="center">
                                                 ...
                                                 {renderHTML( n.description.substring(0, 50) )}
                                            </TableCell>
...
{
    return {
        posts  : courseApp.posts.data,
        searchText: courseApp.posts.searchText,
		postsCount: courseApp.posts.count,
    }
}
