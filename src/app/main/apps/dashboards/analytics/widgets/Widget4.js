...
const Widget4 = ({data, theme, translate}) => {
    ...
    return (
        <Card className="w-full rounded-8 shadow-none border-1">
            ...
            <div className="p-16 pb-0 flex flex-row items-end flex-wrap">
                ...
                <div className="pr-16">
                    <Typography className="h3" color="textSecondary">{translate('Visits')}</Typography>
...
export default withStyles(null, {withTheme: true})(withTranslate(Widget4));
