...
class Widget1 extends Component {
    ...
    render()
    {
        const {classes, mainThemeDark, data: dataRaw, theme, translate} = this.props;
                    ...
                    <div className="container relative p-16 sm:p-24 flex flex-row justify-between items-center">
                        ...
                        <FuseAnimate delay={100}>
                            <div className="flex-col">
                                <Typography className="h2">{translate('Visitors')}</Typography>
                                <Typography className="h5" color="textSecondary">{translate('Unique_visitors_by_month')}</Typography>
                            </div>
                        </FuseAnimate>
...
export default withStyles(styles, {withTheme: true})(connect(mapStateToProps)(withTranslate(Widget1)));
