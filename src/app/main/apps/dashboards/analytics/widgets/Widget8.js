...
class Widget8 extends Component {
    ...
    render()
    {
        const {data, theme, translate} = this.props;
            ...
            <Card className="w-full rounded-8 shadow-none border-1">
                ...
                <AppBar position="static">
                    ...
                    <div className="p-16 pr-4 flex flex-row items-center justify-between">
                        ...
                        <div className="pr-16">
                            <Typography className="h1 font-300" color="inherit">{translate('Anlytice_Sales')}</Typography>
                            <Typography className="h5" color="inherit">{translate('Anlytice_Lifetime_sales')}</Typography>
                        </div>
...
export default withStyles(null, {withTheme: true})(withTranslate(Widget8));
