...
const Widget3 = ({data, theme, translate}) => {
    ...
    return (
        <Card className="w-full rounded-8 shadow-none border-1">
            ...
            <div className="p-16 pb-0 flex flex-row items-end flex-wrap">
                ...
                <div className="pr-16">
                    <Typography className="h3" color="textSecondary">{translate('Impressions')}</Typography>
...
export default withStyles(null, {withTheme: true})(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Widget3)));
