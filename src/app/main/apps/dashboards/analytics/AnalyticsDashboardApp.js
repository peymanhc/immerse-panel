...
class AnalyticsDashboardApp extends Component {
    ...
    render()
    {
        const {widgets, translate} = this.props;
        if ( !widgets )
        {
            return null;
        }
        return (
            <div className="fuse w-full">
                    ...
                    <div className="flex flex-col md:flex-row sm:p-8 container">
                        ...
                        <div className="flex flex-1 flex-col min-w-0">
                            ...
                            <FuseAnimate delay={600}>
                                <Typography className="px-16 pb-8 text-18 font-300">
                                    {translate('How_many_pages_your_users')}
                                </Typography>
                            </FuseAnimate>
                            ...
                            <FuseAnimate delay={600}>
                                <Typography className="px-16 pb-8 text-18 font-300">
                                    {translate('Where_are_your_users')}
                                </Typography>
                            </FuseAnimate>
                        ...
                        <div className="flex flex-wrap w-full md:w-320 pt-16">
                            ...
                            <div className="mb-32 w-full sm:w-1/2 md:w-full">
                                <FuseAnimate delay={600}>
                                    <Typography className="px-16 pb-8 text-18 font-300">
                                        {translate('What_are_your_top_devices')}
                                    </Typography>
                                </FuseAnimate>
                            ...
                            <div className="mb-32 w-full sm:w-1/2 md:w-full">
                                <FuseAnimate delay={600}>
                                    <Typography className="px-16 pb-8 text-18 font-300 lg:pt-0">
                                      {translate('What_are_your_top_campaigns')}
                                    </Typography>
                                </FuseAnimate>
                                <div className="widget w-full p-16">
...
export default withReducer('analyticsDashboardApp', reducer)(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(AnalyticsDashboardApp))));
