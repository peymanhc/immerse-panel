...
class ProjectDashboardApp extends Component {
    ...
    render()
    {
        const {widgets, projects, classes, translate} = this.props;
        ...
        return (
            ...
            <FusePageSimple
                ...
                header={
                    <div className="flex flex-col justify-between flex-1 px-24 pt-24">
                        <div className="flex justify-between items-start">
                            <Typography className="py-0 sm:py-24" variant="h4">{translate('Welcome_back')}</Typography>
                            <Hidden lgUp>
                                <IconButton
                ...
                contentToolbar={
                    ...
                    >
                        <Tab className="text-14 font-600 normal-case" label={translate('Home')}/>
                        <Tab className="text-14 font-600 normal-case" label={translate('Budget_Summary')}/>
                        <Tab className="text-14 font-600 normal-case" label={translate('Team_Members')}/>
                    </Tabs>
                }
                content={
                    <div className="p-12">
...
export default withReducer('projectDashboardApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(
withTranslate(ProjectDashboardApp)))));
