...
{
    return {
        labelDialog: PropertyApp.propertys.labelDialog,
		open: PropertyApp.propertys.labelDialog.open
    }
}

export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(LabelDialog));
