...
const PropertyLabelHeader = ({setSearchText, searchText, pageLayout, mainTheme, openNewPropertyDialog, translate}) => {
    return (
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslate(PropertyLabelHeader));
