...
export const GET_PROPERTYS = '[PROPERTY APP] GET PROPERTYS';
export const UPDATE_PROPERTYS = '[PROPERTY APP] UPDATE PROPERTYS';
export const TOGGLE_STARRED = '[PROPERTY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[PROPERTY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[PROPERTY APP] TOGGLE IMPORTANT';
export const UPDATE_PROPERTY = '[PROPERTY APP] UPDATE PROPERTY';
export const ADD_PROPERTY = '[PROPERTY APP] ADD PROPERTY';
export const REMOVE_PROPERTY = '[PROPERTY APP] REMOVE PROPERTY';
export const SET_SEARCH_TEXT = '[PROPERTY APP] SET SEARCH TEXT';
export const OPEN_NEW_PROPERTY_DIALOG = '[PROPERTY APP] OPEN NEW PROPERTY DIALOG';
export const CLOSE_NEW_PROPERTY_DIALOG = '[PROPERTY APP] CLOSE NEW PROPERTY DIALOG';
export const OPEN_EDIT_PROPERTY_DIALOG = '[PROPERTY APP] OPEN EDIT PROPERTY DIALOG';
export const CLOSE_EDIT_PROPERTY_DIALOG = '[PROPERTY APP] CLOSE EDIT PROPERTY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[PROPERTY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[PROPERTY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[PROPERTY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[PROPERTY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_PROPERTY = '[PROPERTY APP] ADD LOADING PROPERTY';
export const WAIT_PRODUCTS_VOICE = '[E-COMMERCE APP] WAIT_PRODUCTS_VOICE';
...
{
    const request = axios.get('/api/property-app/properties', {
        params: match.params
    });
...
export function updatePropertys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().PropertyApp.propertys;
...
export function updateProperty(property)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, 'put').then((images) => { 
			...
			//console.log(property);
			const request = axios.put('/api/property-app/update-property', property);
...
export function addProperty(property)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, 'post').then((images) => { 
			...
			delete property.images;	
			//console.log(property);
			const request = axios.post('/api/property-app/new-property', property);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/property-app/remove-property', {data:{propertyId}});
...
export function uploadVoiceTO(file)
{
        
    return (dispatch) => {
        dispatch({type: WAIT_PRODUCTS_VOICE, payload: true});
        return uploadVoice(file).then((excel) => { 
            //console.log(excel);
            ...
            dispatch({type: WAIT_PRODUCTS_VOICE, payload: false});
            return new Promise((resolve, reject)=> {
                if(excel.url === undefined)
                    reject();
                else
...
const uploadVoice = (file) => { 
    return new Promise((resolve, reject) => {
        ...
        formData.append(fileName, file);
        axios.post('/api/e-commerce-app/voice-upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));               
    });
};
