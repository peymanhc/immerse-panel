...
export const GET_PROPERTYS = '[IMTV PROPERTY APP] GET PROPERTYS';
export const UPDATE_PROPERTYS = '[IMTV PROPERTY APP] UPDATE PROPERTYS';
export const TOGGLE_STARRED = '[IMTV PROPERTY APP] TOGGLE STARRED';
export const TOGGLE_COMPLETED = '[IMTV PROPERTY APP] TOGGLE COMPLETED';
export const TOGGLE_IMPORTANT = '[IMTV PROPERTY APP] TOGGLE IMPORTANT';
export const UPDATE_PROPERTY = '[IMTV PROPERTY APP] UPDATE PROPERTY';
export const ADD_PROPERTY = '[IMTV PROPERTY APP] ADD PROPERTY';
export const REMOVE_PROPERTY = '[IMTV PROPERTY APP] REMOVE PROPERTY';
export const SET_SEARCH_TEXT = '[IMTV PROPERTY APP] SET SEARCH TEXT';
export const OPEN_NEW_PROPERTY_DIALOG = '[IMTV PROPERTY APP] OPEN NEW PROPERTY DIALOG';
export const CLOSE_NEW_PROPERTY_DIALOG = '[IMTV PROPERTY APP] CLOSE NEW PROPERTY DIALOG';
export const OPEN_EDIT_PROPERTY_DIALOG = '[IMTV PROPERTY APP] OPEN EDIT PROPERTY DIALOG';
export const CLOSE_EDIT_PROPERTY_DIALOG = '[IMTV PROPERTY APP] CLOSE EDIT PROPERTY DIALOG';
export const TOGGLE_ORDER_DESCENDING = '[IMTV PROPERTY APP] TOGGLE ORDER DESCENDING';
export const CHANGE_ORDER = '[IMTV PROPERTY APP] CHANGE ORDER';
export const OPEN_NEW_LABEL_DIALOG = '[IMTV PROPERTY APP] OPEN NEW LABEL DIALOG';
export const CLOSE_NEW_LABEL_DIALOG = '[IMTV PROPERTY APP] CLOSE NEW LABEL DIALOG';
export const WAIT_PROPERTY = '[IMTV PROPERTY APP] ADD LOADING PROPERTY';
...
{
    const request = axios.get('/api/imtv-property-app/properties', {
        params: match.params
    });
...
export function updatePropertys()
{
    return (dispatch, getState) => {
        ...
        const {routeParams} = getState().imtvPropertyApp.propertys;
...
const uploadImage = (file, id, type) => {	
	return new Promise((resolve, reject) => {
		...
		if(type === 'post')
			axios.post('/api/imtv-property-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	
		else
			axios.put('/api/imtv-property-app/upload', formData).then(({data}) => resolve(data)).catch((e) => reject(e));	 			
	});
};
...
export function updateProperty(property)
{
	...
	return (dispatch) => {
		...
		return saveImage(images, 'put').then((images) => { 
			...
			//console.log(property);
			const request = axios.put('/api/imtv-property-app/update-property', property);
...
export function addProperty(property)
{
	...
	return (dispatch) => {   //important for sync funstions
		...
		return saveImage(images, 'post').then((images) => { 
			...
			delete property.images;	
			//console.log(property);
			const request = axios.post('/api/imtv-property-app/new-property', property);
			return request.then(() => { 
...
{
    const request = axios.delete('/api/imtv-property-app/remove-property', {data:{propertyId}});
