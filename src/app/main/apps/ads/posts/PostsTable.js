...
class PostsTable extends Component {
    ...
    handleClick = (item) => {
        this.props.history.push('/apps/ads/posts/' + item.id + '/' + item.name);
    };
                            ...
                            {_.orderBy(data, [
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            <TableCell className="w-48 pr-4 sm:pr-12" padding="checkbox">
                                                <Checkbox
                                                    checked={isSelected}
...
{
    return {
        posts  : adsApp.posts.data,
        searchText: adsApp.posts.searchText,
		postsCount: adsApp.posts.count,
    }
}
