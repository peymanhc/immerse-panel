        ...
        <div className="flex flex-1 w-full items-center justify-between">
            ...
            <div className="flex items-center">
                ...
                <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                    <Typography className="hidden sm:flex" variant="h6">لیست  آگهی ها</Typography>
                </FuseAnimate>
            </div>
            ...
            <FuseAnimate animation="transition.slideRightIn" delay={300}>
                <Button component={Link} to="/apps/ads/posts/new" className="whitespace-no-wrap" variant="contained">
                    <span className="hidden sm:flex"> ثبت آگهی جدید</span>
...
{
    return {
        searchText: adsApp.posts.searchText,
