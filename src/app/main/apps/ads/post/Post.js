    ...
    render()
    {
	   ...
	   if(form)
		...
		if(form && form.id && form.name)
			postLink = window.location.origin + "/ads/post-full/" + form.id + "/" + form.name.split(' ').join('-');
                        ...
                        <div className="flex flex-1 w-full items-center justify-between">
                            ...
                            <div className="flex flex-col items-start max-w-full">
                                ...
                                <FuseAnimate animation="transition.slideRightIn" delay={300}>
                                    <Typography className="normal-case flex items-center sm:mb-12" component={Link} role="button" to="/apps/ads/posts">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                                            <Typography className="text-16 sm:text-20 truncate">
                                                {form.name ? form.name : translate('New_ads')}
                                            </Typography>
                                        </FuseAnimate>
                                        <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                                ...
                                <div>
                                 <div className="flex">   
									<TextField
                                        ...
                                        fieldsetProps={{ className: classes.field,}}    
									/>
                                          <TextField
                                        className="mt-8 mb-16 mr-8"
                                        error={form.code === ''}                                        
...
function mapStateToProps({adsApp})
{
    return {
        post: adsApp.post ,
        users         : adsApp.post.users
    }
}

export default 
	withReducer('adsApp', reducer)(withStyles(styles, {withTheme: true})(withRouter(connect(mapStateToProps, mapDispatchToProps)(withTranslate(Post)))));
